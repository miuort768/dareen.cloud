...
export const QuickSearch = () => {
    ...
    return (
        <>
            ...
            <div className="fixed top-24 start-1/2 -translate-x-1/2 w-full max-w-2xl z-[70] px-4 animate-in zoom-in-95 duration-200">
                <div className="bg-white dark:bg-card border-t-4 border-primary shadow-2xl overflow-hidden rounded-none">
                    <div className="flex items-center gap-4 p-5 bg-background dark:bg-card/50">
                        ...
                        <input
                            ...
                            className="flex-1 bg-transparent outline-none text-lg font-bold text-main dark:text-on-primary placeholder-gray-400 text-end"
                            dir="rtl"
                        />
                            ...
                            results.map((result, index) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={cn(
                                            "w-full flex items-center gap-4 p-4 transition-all text-end group",
