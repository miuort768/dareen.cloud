  ...
  return (
    <div ref={ref} className={cn('relative inline-block', className)}>
      <button
        ...
        className="flex min-h-[44px] items-center gap-1 text-sm font-medium text-main md:min-h-0"
        aria-expanded={open}
        aria-haspopup="true"
      >
        {trigger}
        ...
        >
          {items.map((item) => (
            <button
              ...
              role="menuitem"
              className={cn(
                'flex min-h-[44px] w-full items-center gap-2 px-4 py-2.5 text-start text-sm transition-colors duration-fast md:min-h-[36px]',
