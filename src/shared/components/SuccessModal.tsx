    ...
    return (
        <div className="fixed bottom-6 left-6 z-[9999] w-full max-w-sm pointer-events-none px-4 sm:px-0" dir="rtl">
            <div className={cn(
                ...
                'shadow-[0_10px_30px_#10B98114] dark:shadow-[0_10px_30px_#00000066]',
                ...
                <div className="flex items-start gap-3.5 relative z-10">
                    ...
                    <div className="flex-shrink-0 relative">
                        <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-[var(--bg-success)] to--[var(--bg-info)] flex items-center justify-center text-on-primary shadow-[0_4px_12px_#10B9814D] animate-pulse">
                    ...
                    <div className="flex-1 min-w-0 pt-0.5">
                        ...
                        <p className="text-[11px] text-muted dark:text-muted mt-1.5 leading-relaxed font-medium">
                            {message}
                        </p>
                    </div>
