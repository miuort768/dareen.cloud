...
export const SendNotificationModal: React.FC<SendNotificationModalProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative max-h-[92dvh] w-full overflow-y-auto border-x-0 border-t-2 border-primary/50 bg-card shadow-elevation-3 duration-normal animate-in slide-in-from-bottom dark:bg-card md:max-h-none md:max-w-md md:overflow-hidden md:border-x-2 md:border-b-2 md:animate-in md:zoom-in-95">
        {/* Accent bar */}
