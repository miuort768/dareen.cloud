            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-6">
                <div className="flex-1 min-w-0">
                    <p className="text-sm font-bold text-white/80 dark:text-main/90 mb-1">
                        {getGreeting()}، {firstName} <span className="inline-flex items-center justify-center w-5 h-5 rounded bg-white/15 dark:bg-white/20 align-middle"><RankIconComponent size={12} className="text-white dark:text-primary" /></span>
                    </p>
