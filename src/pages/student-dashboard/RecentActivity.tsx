                        ...
                        <div key={log.id || `log-${i}`} className="flex items-start gap-3 relative">
                            ...
                            <div className="flex-1 min-w-0 flex items-center justify-between gap-2">
                                <div className="min-w-0">
                                    ...
                                    {log.date && (
                                        <p className="text-[11px] text-muted dark:text-muted flex items-center gap-1 mt-0.5">
                                            <Clock size={9} /> {log.date}
                                        </p>
                                    )}
                                </div>
                                <span className="text-xs font-bold text-success bg-success-soft dark:bg-success/10 px-2 py-0.5 rounded-lg shrink-0">
                                    +{log.amount}
                                </span>
                            </div>
                        </div>
