            ...
            <div className="p-5 md:p-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 bg-primary dark:bg-primary text-on-primary dark:text-on-primary text-xs font-semibold px-5 py-2.5 rounded-lg active:scale-95 transition-all duration-200 shrink-0 hover:bg-primary-hover dark:hover:bg-[#D4AF37]/90 hover:shadow-md"
