...
const ARABIC_DAYS = ['«·√Õœ', '«·≈À‰Ì‰', '«·À·«À«¡', '«·√—»⁄«¡', '«·Œ„Ì”', '«·Ã„⁄…', '«·”» '];
            ...
            (en.schedule || []).forEach((slot) => {
                if (slot.day === todayDay) {
                    ...
                    if (diff > 0 && diff < minDiff) {
                        minDiff = diff;
                        closest = { subject: en.subject || 'œÊ—…', teacher: en.teacherName || en.teacher || '', time: slot.hour || '', hour: slot.hour || '', day: slot.day, enrollment: en };
                    }
                }
            });
        });
