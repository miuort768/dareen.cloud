...
export const NextSessionRadar = ({ session }: NextSessionRadarProps) => {
  ...
  return (
    <section
      aria-label="الحصة القادمة"
      className="overflow-hidden rounded-3xl border border-primary/30 bg-surface shadow-sm transition-colors duration-300"
    >
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 p-5">
        ...
        <button
          ...
          className="inline-flex shrink-0 items-center justify-center gap-1.5 rounded-xl bg-primary px-4 py-2.5 text-xs font-black text-on-primary shadow-sm transition-all duration-200 hover:bg-primary-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus active:scale-95"
