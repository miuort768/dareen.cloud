...
export const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-background font-sans relative">
            ...
            <div className="min-h-screen flex flex-col items-center justify-center px-4 py-8 md:py-0">
                {/* Hero image overlapping the card */}
                <div className="relative -mb-10 z-10">
                    <div className="w-28 h-28 md:w-36 md:h-36 bg-gradient-to-br from-primary via-primary-deep to-primary-hover rounded-3xl flex items-center justify-center shadow-xl shadow-primary/20 border-4 border-white dark:border-background overflow-hidden">
                        <Image src="/bbook.png" alt={academyName} className="w-full h-full" imgClassName="object-contain p-3 drop-shadow-lg" />
                    </div>
                </div>

                {/* Form card */}
                <div className="w-full max-w-md bg-card border border-border rounded-3xl shadow-elevation-2 p-8 md:p-10">
                    {/* Heading */}
                    <div className="text-center mb-8">
                        <h1 className="text-2xl md:text-3xl font-black text-main mb-2 font-heading">تسجيل الدخول</h1>
                        <p className="text-muted text-sm font-medium">{academyName}</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            ...
                            disabled={loading}
                            className={cn(
                                "w-full h-12 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all duration-300 mt-2",
                    ...
                    <div className="mt-6 flex flex-col items-center gap-3">
                        ...
                        <div className="pt-4 border-t border-border w-full">
                            <a
                                ...
                                className="w-full h-11 bg-success/10 hover:bg-success/20 text-success rounded-xl font-bold flex items-center justify-center gap-2 transition-all"
                            >
                                <Headphones size={18} />
