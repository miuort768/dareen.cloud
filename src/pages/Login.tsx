...
import { 
    ...
    Sparkles, Users, Trophy, CheckCircle, ShieldCheck, Star
} from 'lucide-react';
                ...
                <div className="hidden md:flex md:w-1/2 bg-transparent relative flex-col justify-center items-center">
                    ...
                    <div className="relative z-10 w-full max-w-md flex flex-col items-start justify-center p-8 text-right" dir="rtl">
                        ...
                        <div className="mt-8 flex flex-wrap gap-8">
                            ...
                            <div className="flex items-center gap-3">
                                <img src="/logo.png" className="w-5 h-5 object-contain opacity-50" alt="Logo" />
                ...
                <div className="w-full md:w-1/2 flex items-center justify-center p-4 sm:p-8 lg:p-12 bg-transparent">
                    <div className="w-full max-w-md relative z-10">
                        <div className="text-center mb-10">
                            <div className="w-24 h-24 sm:w-28 sm:h-28 bg-white/50 backdrop-blur-md rounded-3xl flex items-center justify-center mx-auto mb-8 relative shadow-xl shadow-black/5 overflow-hidden border border-white/20">
                                <img src="/logo.png" alt="Logo" className="w-20 h-20 object-contain p-2" />
                            </div>
