        ...
        <div className="min-h-screen bg-surface flex font-sans overflow-x-hidden overflow-y-auto relative transition-colors duration-500">
            ...
            <div className="w-full min-h-screen flex flex-col md:flex-row justify-center items-start md:items-center max-w-7xl mx-auto relative z-10 px-4 pt-24 pb-12 md:pt-32">
                ...
                <div className="hidden md:flex md:w-1/2 bg-transparent relative flex-col justify-center items-center">
                    ...
                    <div className="relative z-10 w-full max-w-md flex flex-col items-start justify-center p-8 text-end" dir="rtl">
                        <div className="mb-10 w-full">
                            ...
                            <h2 className="text-section font-bold text-main mb-8 leading-tight border-e-8 border-success pe-8 min-h-[4.5rem]">
                                {typedText}
                    ...
                    <div className="w-full max-w-md relative z-10">
                        <div className="text-center mb-8">
                            <div className="w-24 h-24 sm:w-28 sm:h-28 bg-main rounded-card flex items-center justify-center text-inverse mx-auto mb-6 relative shadow-card overflow-visible">
                                <Crown className="absolute -top-7 -start-3 text-accent drop-shadow-lg transform -rotate-12 z-30" size={50} strokeWidth={2.5} fill="var(--bg-accent)" />

                                <div className="absolute top-1/2 start-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center gap-1.5 z-20 w-40 mt-1">
                                    <div className="relative w-14 h-14 bg-card rounded-card border-[5px] border-error overflow-hidden shadow-inner flex shrink-0">
                                        <div className="absolute inset-0 flex items-center justify-center bg-surface/50">
                                            <div className={`w-4 h-4 bg-main rounded-full transition-transform duration-300 ${isPasswordFocused ? 'translate-y-6 scale-90' : 'scale-100'} relative`}>
                                                <div className="absolute top-0.5 end-0.5 w-1 h-1 bg-card rounded-full opacity-90"></div>
                                            </div>
                                        </div>
                                        <div className={`absolute top-0 start-0 w-full bg-main transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] z-10 ${isPasswordFocused ? 'h-full' : 'h-0'}`} />
                                    </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        className="absolute start-3 top-[38px] text-dim hover:text-main transition-colors"
                                        tabIndex={-1}
                                    >
