        ...
        <div className="min-h-full pb-24 overflow-x-hidden relative bg-gradient-to-br from-slate-50 via-white to-indigo-50/30 dark:from-[#020617] dark:via-slate-950 dark:to-indigo-950/20 font-sans" dir="rtl">
            ...
            {loading ? (
                ...
                <div className="text-center py-20 bg-slate-50 dark:bg-slate-900 border-2 border-dashed border-slate-200 dark:border-slate-800">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 font-normal">لا يوجد مقالات حالياً، ابدأ بإضافة أول مقال!</p>
                </div>
            ) : (
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60   animate-fade-in">
                    <div className="bg-white dark:bg-slate-900 w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col shadow-sm border border-slate-200 dark:border-slate-800">
                        <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
                            <h2 className="text-xl font-medium">{currentPost.id ? 'تعديل مقال' : 'إضافة مقال جديد'}</h2>
                        ...
                        <form onSubmit={handleSubmit} className="flex-grow overflow-y-auto p-6 space-y-6 custom-scrollbar">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <label className="text-xs font-medium text-slate-400 uppercase tracking-widest block">عنوان المقال</label>
                                    <input
                                        required
                                        type="text"
                                ...
                                <div className="space-y-2">
                                    <label className="text-xs font-medium text-slate-400 uppercase tracking-widest block">الرابط المختصر (Slug)</label>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="space-y-2">
                                    <label className="text-xs font-medium text-slate-400 uppercase tracking-widest block">التصنيف</label>
                                    <div className="relative">
                                ...
                                <div className="space-y-2">
                                    <label className="text-xs font-medium text-slate-400 uppercase tracking-widest block">الكاتب</label>
                                    <input
                                        type="text"
                                ...
                                <div className="space-y-2">
                                    <label className="text-xs font-medium text-slate-400 uppercase tracking-widest block">التاريخ</label>
                                    <input
                                        type="date"
                            ...
                            <div className="bg-indigo-50 dark:bg-indigo-950/30 border border-indigo-100 dark:border-indigo-800 p-4">
                                <p className="text-[10px] font-medium text-indigo-600 uppercase tracking-widest mb-4">تصنيف المحتوى — يظهر في نظام التصفح</p>
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                    <div className="space-y-1">
                                        <label className="text-[10px] font-medium text-slate-400 uppercase">نوع المحتوى</label>
                                    ...
                                    <div className="space-y-1">
                                        <label className="text-[10px] font-medium text-slate-400 uppercase">المنهج</label>
                                    ...
                                    <div className="space-y-1">
                                        <label className="text-[10px] font-medium text-slate-400 uppercase">المرحلة</label>
                                    ...
                                    <div className="space-y-1">
                                        <label className="text-[10px] font-medium text-slate-400 uppercase">الصف</label>
                                    ...
                                    <div className="space-y-1">
                                        <label className="text-[10px] font-medium text-slate-400 uppercase">الترم</label>
                                    ...
                                    <div className="space-y-1">
                                        <label className="text-[10px] font-medium text-slate-400 uppercase">المادة</label>
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-medium text-slate-400 uppercase tracking-widest block">رابط صورة الغلاف</label>
                                <div className="relative">
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-medium text-slate-400 uppercase tracking-widest block">الكلمات الدلالية (Keywords) - مفصولة بفاصلة</label>
                                <input
                                    type="text"
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-medium text-slate-400 uppercase tracking-widest block">مقتطف المقال (الظاهر في الخارج)</label>
                                <textarea
                                    rows={2}
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-medium text-slate-400 uppercase tracking-widest block">محتوى المقال (يدعم HTML)</label>
                                <textarea
                                    rows={10}
                                    required
