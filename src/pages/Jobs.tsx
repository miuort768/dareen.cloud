            ...
            <div className="min-h-screen bg-[#fafafa] font-sans flex flex-col" dir="rtl" style={{ '--color-primary': '42 22 112' } as React.CSSProperties}>
                ...
                <main className="flex-grow flex items-start md:items-center justify-center px-4 md:pt-0 pt-8 pb-20">
                    <motion.div
                        ...
                        className="max-w-md w-full bg-white border-2 border-emerald-500/30 p-10 md:p-14 text-center shadow-xl relative overflow-hidden"
                    >
                        ...
                        <div className="relative z-10">
                            <motion.div
                                ...
                                className="w-20 h-20 bg-emerald-100 flex items-center justify-center mx-auto mb-6 border-2 border-emerald-200"
                            >
                                <CheckCircle2 size={40} className="text-emerald-600" />
                            </motion.div>
                            <h2 className="text-2xl font-black text-slate-900 mb-2">تم استلام طلبك!</h2>
                            <p className="text-sm text-slate-500 font-medium">سنقوم بمراجعة طلبك والتواصل معك في أقرب فرصة. بارك الله فيك.</p>
                        </div>
                    </motion.div>
                </main>
                <PublicFooter />
    ...
    return (
        <div className="min-h-screen bg-[#fafafa] font-sans flex flex-col" dir="rtl" style={{ '--color-primary': '42 22 112' } as React.CSSProperties}>
            ...
            <section className="relative pt-2 md:pt-28 pb-4 md:pb-12 overflow-hidden bg-gradient-to-br from-primary-500 via-primary-600 to-primary-700">
                ...
                <div className="absolute bottom-0 left-0 w-full h-10 md:h-16 bg-gradient-to-t from-[#fafafa] to-transparent" />
            </section>
...
const InputField = forwardRef<HTMLInputElement, InputFieldProps>(({ icon: Icon, label, name, value, onChange, placeholder, required, type = 'text', inputMode, autoComplete }, ref) => (
    <div className="space-y-1.5">
        <label className="flex items-center gap-2 text-[10px] font-black text-slate-500">
            ...
            {!required && <span className="text-[9px] text-slate-400 font-normal">(اختياري)</span>}
        </label>
        <input
            ref={ref}
            type={type}
