            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-16">
                <div className="lg:col-span-7 space-y-12">
                    <div>
                        ...
                        <div className="w-20 h-1.5 bg-[#6C4BFF]"></div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        ...
                        <div className="group transition-all">
                            <p className="text-[10px] font-black text-[#6C4BFF] uppercase tracking-[0.2em] mb-3">إجمالي عوائد المنظومة</p>
                            <div className="flex items-baseline gap-2">
                                <p className="text-6xl font-black tracking-tighter italic group-hover:scale-105 transition-transform origin-right">
                ...
                <div className="lg:col-span-5">
                    <div className="bg-white/[0.02] border border-white/10 p-10 h-full flex flex-col justify-between rounded-2xl relative">
                        <div className="absolute top-0 right-0 w-2 h-2 bg-[#6C4BFF] -translate-x-1/2 -translate-y-1/2"></div>
                        <div className="absolute bottom-0 left-0 w-2 h-2 bg-[#6C4BFF] translate-x-1/2 translate-y-1/2"></div>

                        <div>
                            <h3 className="text-xs font-black text-[#6C4BFF] uppercase tracking-[0.3em] mb-10 flex items-center gap-3">
                                <span className="w-6 h-[1px] bg-[#6C4BFF]"></span>
                                ملاحظات التدقيق المالي
                            </h3>
                            <div className="space-y-10">
                                <div className="flex gap-6">
                                    <div className="shrink-0 w-8 h-8 bg-white text-slate-950 flex items-center justify-center font-black text-xs italic rounded-xl">01</div>
                                ...
                                <div className="flex gap-6">
                                    <div className="shrink-0 w-8 h-8 bg-[#6C4BFF] text-white flex items-center justify-center font-black text-xs italic rounded-xl">02</div>
                                    <p className="text-[11px] font-bold leading-relaxed text-slate-300 italic">
                            ...
                            <div className="mt-12 p-6 bg-white/[0.03] border-r-2 border-[#6C4BFF] rounded-xl">
