                    ...
                    <div className="p-3">
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-border">
                            <div className="flex gap-2">
                                <button onClick={() => handleOpenModal(post)} className="w-8 h-8 flex items-center justify-center rounded-lg text-info hover:bg-info-soft transition-all duration-200 active:scale-95" aria-label="تعديل"><Edit2 size={14} /></button>
                                <button onClick={() => handleDelete(post.id)} className="w-8 h-8 flex items-center justify-center rounded-lg text-error hover:bg-error-soft transition-all duration-200 active:scale-95" aria-label="حذف"><Trash2 size={14} /></button>
                            </div>
