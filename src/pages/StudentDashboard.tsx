...
export const StudentDashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-surface font-sans overflow-x-hidden" dir="rtl">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                                ...
                                <span className="absolute top-1 end-1 w-2 h-2 bg-error rounded-full border-2 border-card" />
                            </button>
                            {/* Live clock */}
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            ...
                            <div className="shrink-0 relative z-10">
                                    ...
                                    {/* Floating badge */}
                                    <div className="absolute -bottom-2 -end-2 bg-card rounded-full px-2 py-1 shadow-lg flex items-center gap-1">
                ...
                {enrollments.length > 0 ? (
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-micro text-dim text-end mb-2">
                    ...
                    <div className="bg-card rounded-card p-4 shadow-sm border border-border flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-micro text-dim text-end mb-2">المستوى المبتدئ</p>
                            <div className="relative">
                                <div className="h-2 bg-hover rounded-full overflow-hidden">
                                    <motion.div
                                        initial={{ width: 0 }}
                                ...
                                <span className="text-micro font-bold text-primary mt-1 block text-start">60%</span>
                            </div>
                        </div>
                    </div>
                )}
            ...
            {pointLogs.length > 0 && (
                <div className="px-4 py-3">
                    <h2 className="text-lg font-black text-main mb-3 text-end">آخر النشاطات</h2>
            ...
            <div className="px-4 py-3 pb-6">
                <div className="bg-gradient-to-br from-primary to-primary-hover rounded-3xl p-5 relative overflow-hidden shadow-xl shadow-black/10">
                    ...
                    <div className="relative z-10">
                        <h3 className="text-on-primary font-black text-lg mb-1 text-end">تحتاج مساعدة؟</h3>
                        <p className="text-on-primary opacity-80 text-xs mb-4 text-end">فريقنا جاهز لمساعدتك في أي وقت</p>
                        <a
...
const MobileBottomNav = ({
    ...
    return (
        <nav className="fixed bottom-0 start-0 end-0 z-50 bg-card border-t border-border pb-[env(safe-area-inset-bottom)] shadow-2xl shadow-black/10">
                        ...
                        >
                            {isCenter ? (
                                ...
                                <>
                                    ...
                                    {isActive && (
                                        <div className="absolute top-0 start-1/2 -translate-x-1/2 w-5 h-0.5 bg-primary rounded-full" />
                                    )}
                                </>
                            )}
                        </button>
