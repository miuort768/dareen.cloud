            ...
            <div className="max-w-4xl mx-auto px-2 mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <input 
                                            ...
                                            className="w-full bg-background dark:bg-primary-active/50 border-none rounded-none px-4 py-3 pe-10 text-sm font-normal text-main dark:text-on-primary focus:ring-2 focus:ring-error/20 transition-all"
                                            placeholder="��������"
                                        />
                                        <Lock className="absolute end-3 top-1/2 -translate-y-1/2 text-dim" size={16} />
                                    </div>
                                </div>
                                <div>
                                    <label className="block text-xs font-medium text-muted dark:text-muted uppercase tracking-widest mb-2 ms-1">����� ���� ����</label>
                                    <div className="relative">
                                        <input 
                                            ...
                                            placeholder="��������"
                                        />
                                        <CheckCircle2 className="absolute end-3 top-1/2 -translate-y-1/2 text-dim" size={16} />
                                    </div>
                                </div>
                            </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-br from-[var(--bg-primary)] to-primary rounded-none p-6 text-on-primary shadow-sm relative overflow-hidden group">
                        <div className="absolute top-0 end-0 w-32 h-32 bg-white/10 rounded-full -translate-y-1/2 translate-x-1/2 blur-2xl group-hover:scale-150 transition-transform duration-700" />
