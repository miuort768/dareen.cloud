...
const THEME_COLORS = [
    { id: 'indigo', label: '����', class: 'bg-indigo-500' },
    { id: 'blue', label: '����', class: 'bg-blue-500' },
    { id: 'emerald', label: '�����', class: 'bg-emerald-500' },
    { id: 'rose', label: '����', class: 'bg-rose-500' },
    { id: 'amber', label: '�������', class: 'bg-amber-500' },
    { id: 'purple', label: '�������', class: 'bg-purple-500' },
    { id: 'cyan', label: '����', class: 'bg-cyan-500' },
    { id: 'teal', label: '������', class: 'bg-teal-500' },
    { id: 'orange', label: '�������', class: 'bg-orange-500' },
    { id: 'pink', label: '����', class: 'bg-pink-500' },
    { id: 'lava', label: '���', class: 'bg-orange-600' },
    { id: 'midnight', label: '����', class: 'bg-slate-900' },
    { id: 'gold', label: '����', class: 'bg-amber-400' },
    { id: 'crimson', label: '�����', class: 'bg-rose-600' },
];
                ...
                <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-6 relative z-10">
                    ...
                    <div className="flex gap-2">
                         <div className="flex flex-col items-center px-4 py-2 bg-slate-50 dark:bg-slate-800/50 rounded-none border border-slate-100 dark:border-slate-800">
                            <span className="text-[10px] text-slate-400 font-normal uppercase mb-1">����� ��������</span>
            ...
            <div className="max-w-4xl mx-auto px-2 mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-none p-6 shadow-sm border border-slate-100 dark:border-slate-800">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="font-medium text-slate-800 dark:text-white tracking-tight">��������� ��������</h2>
                        </div>

                        <div className="space-y-4">
                            <div>
                                <label className="block text-[11px] font-medium text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 mr-1">����� ������</label>
                                <input 
                                    type="text" 
                                    value={name}
                ...
                <div className="space-y-6">
                    <div className="bg-white dark:bg-slate-900 rounded-none p-6 shadow-sm border border-slate-100 dark:border-slate-800 h-fit">
                        ...
                        <p className="text-[11px] text-slate-400 mb-4 font-normal uppercase tracking-tighter">���� ����� ���� ����� ������ ������</p>
                    ...
                    <div className="bg-gradient-to-br from-indigo-600 to-primary-700 rounded-none p-6 text-white shadow-sm relative overflow-hidden group">
                        ...
                        <button onClick={() => showNotification('سيتم توفير خاصية التواصل قريباً', 'info')} className="w-full bg-white/20 hover:bg-white/30  text-white border border-white/20 py-2.5 rounded-lg text-xs font-medium uppercase tracking-widest transition-all">
                            تواصل معنا
                        </button>
                    </div>
                </div>
