                ...
                <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-6 relative z-10">
                    ...
                    <div className="flex gap-2">
                         <div className="flex flex-col items-center px-4 py-2 bg-slate-50 dark:bg-slate-800/50 rounded-none border border-slate-100 dark:border-slate-800">
                            <span className="text-[10px] text-slate-400 font-normal uppercase mb-1">تاريخ الانضمام</span>
                            <span className="text-xs font-medium text-slate-700 dark:text-slate-200">سبتمبر 2023</span>
                         </div>
                    </div>
                </div>
            </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-none p-6 shadow-sm border border-slate-100 dark:border-slate-800">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="font-medium text-slate-800 dark:text-white tracking-tight">المعلومات الأساسية</h2>
                        </div>

                        <div className="space-y-4">
                            <div>
                                <label className="block text-[11px] font-medium text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 mr-1">الاسم الكامل</label>
                                <input 
                                    type="text" 
                                    value={name}
                            ...
                            <div>
                                <label className="block text-[11px] font-medium text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 mr-1">اسم المستخدم (لا يمكن تغييره)</label>
                                <input 
                                    type="text" 
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-none p-6 shadow-sm border border-slate-100 dark:border-slate-800">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="font-medium text-slate-800 dark:text-white tracking-tight">أمان الحساب</h2>
                        </div>

                        <div className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-[11px] font-medium text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 mr-1">كلمة السر الجديدة</label>
                                ...
                                <div>
                                    <label className="block text-[11px] font-medium text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-2 mr-1">تأكيد كلمة السر</label>
                                    <div className="relative">
                                        <input 
                                            type="password" 
                ...
                <div className="space-y-6">
                    <div className="bg-white dark:bg-slate-900 rounded-none p-6 shadow-sm border border-slate-100 dark:border-slate-800 h-fit">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="font-medium text-slate-800 dark:text-white tracking-tight">سمات الألوان</h2>
                        </div>

                        <p className="text-[11px] text-slate-400 mb-4 font-normal uppercase tracking-tighter">اختر اللون الذي تفضله لواجهة المنصة</p>
