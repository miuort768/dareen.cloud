            ...
            {activeTimers.length > 0 && (
                <div className="space-y-3">
                    {activeTimers.map((session: any) => {
                        ...
                        return (
                            <div key={session.id} className="bg-rose-500 text-white p-4 rounded-3xl flex items-center justify-between shadow-lg shadow-rose-500/20 animate-in slide-in-from-top duration-500">
