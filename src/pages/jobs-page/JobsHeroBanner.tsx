      ...
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-3 md:flex-row md:gap-10">
        <div className="flex-1 text-center md:text-start">
          ...
          <motion.p
            ...
            className="text-on-primary/70 mb-4 max-w-lg text-xs leading-relaxed md:mb-0 md:text-lg"
          >
            نبحث عن{' '}
        ...
        >
          <div className="flex h-40 w-40 items-center justify-center rounded-card bg-white/15 md:h-52 md:w-52">
            <div className="text-center">
              ...
              <span className="text-on-primary/70 block text-xs font-bold">نحن ننتظرك</span>
            </div>
          </div>
        </motion.div>
      </div>
