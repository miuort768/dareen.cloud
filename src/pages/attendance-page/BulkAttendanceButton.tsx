    ...
    return (
        <div className="px-0 mb-2">
            <button onClick={handleBulk}
                className="w-full flex items-center justify-center gap-2 bg-success hover:brightness-90 text-on-success text-xs font-bold px-4 py-3.5 rounded-xl transition-all shadow-sm active:scale-95">
