          ...
          {filteredLeads.map((lead, idx) => {
            ...
            return (
              <motion.article
                ...
                className="cursor-pointer overflow-hidden rounded-2xl border border-border bg-card shadow-elevation-1 outline-none transition-all duration-normal hover:border-primary/25 hover:shadow-[0_0_20px_rgb(99_102_241/0.08)] hover:shadow-elevation-2 focus-visible:ring-2 focus-visible:ring-focus active:scale-[0.99] dark:shadow-none"
              >
                {/* Identity */}
