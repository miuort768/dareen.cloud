...
export const LeadsSkeleton = () => (
    <div className="bg-background min-h-screen pb-24" dir="rtl">
        <div className="relative z-10 mx-auto px-4 max-w-page">
            ...
            <div className="bg-card dark:bg-[#131836]/80 rounded-2xl border border-border dark:border-white/[0.04] overflow-hidden shadow-elevation-1 dark:shadow-none">
                ...
                <div className="lg:hidden p-3 space-y-2.5">
                    {Array.from({ length: 4 }).map((_, i) => (
                        <div key={i} className="bg-card dark:bg-[#131836]/80 border border-border dark:border-white/[0.06] rounded-2xl p-4 space-y-3">
