            ...
            <Virtuoso
                ...
                fixedHeaderContent={() => (
                    <div className="flex items-center px-5 py-3 bg-gradient-to-l from-primary to-primary-deep">
                        <div className="w-[22%] px-2 font-bold text-[11px] tracking-wide text-on-primary text-end">العميل</div>
                        <div className="w-[13%] px-2 font-bold text-[11px] tracking-wide text-on-primary text-end">التواصل</div>
                        <div className="w-[13%] px-2 font-bold text-[11px] tracking-wide text-on-primary text-end">المادة</div>
                        <div className="w-[14%] px-2 font-bold text-[11px] tracking-wide text-on-primary text-end">الحالة</div>
                        <div className="w-[10%] px-1 font-bold text-[11px] tracking-wide text-on-primary text-center">الأولوية</div>
                        <div className="w-[28%] px-2 font-bold text-[11px] tracking-wide text-on-primary text-center">الإجراءات</div>
                    </div>
                )}
