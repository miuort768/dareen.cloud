    ...
    return (
        ...
        >
            ...
            <main className="max-w-page mx-auto px-4 pt-4 pb-28 space-y-3 md:space-y-4">
                <motion.div {...fadeUp(0)}>
                    <HeroSection
                        name={currentUser?.name || currentUser?.username || 'Ê·Ì «·√„—'}
                        children={children}
                        ...
                        <motion.div {...fadeUp(0.3)}>
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-sm font-bold text-main dark:text-main">”Ã· «·œ›⁄« </p>
                                    <p className="text-[11px] text-muted dark:text-muted">⁄—÷ ›Ê« Ì— √»‰«∆ﬂ Ê„œ›Ê⁄« ﬂ</p>
                                </div>
