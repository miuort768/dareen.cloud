    ...
    return (
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-primary-deep to-primary-hover dark:from-primary dark:via-primary-deep dark:to-warning p-6 md:p-8">
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-6">
                ...
                {/* Right: Attendance ring + Stats */}
                <div className="flex items-center gap-4">
                    <div className="relative shrink-0">
                        <svg className="w-[120px] h-[120px] -rotate-90" viewBox="0 0 120 120">
                            <circle cx="60" cy="60" r={radius} fill="none" stroke="rgba(255,255,255,0.15)" strokeWidth="8" className="dark:stroke-primary/20" />
                            <circle
                    ...
                    <div className="hidden sm:flex flex-col gap-1.5">
                        <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/10">
                            ...
                            <span className="text-white/80 text-xs font-medium">التقدم</span>
                            <span className="text-white font-bold text-sm">{academicProgress}%</span>
                        </div>
                        <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/10">
                            <Users size={14} className="text-white/80" />
                            <span className="text-white/80 text-xs font-medium">الأبناء</span>
                            <span className="text-white font-bold text-sm">{children.length}</span>
                        </div>
                    </div>
                </div>
            </div>
