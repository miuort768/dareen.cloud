import { CalendarCheck, CircleDashed, XCircle, Radio } from 'lucide-react'
  ...
  return (
    ...
    >
      <div className="mb-4 flex items-center justify-between">
        ...
        <span className="rounded-2xl bg-primary-soft px-2.5 py-1 text-[11px] font-black tabular-nums text-primary">
            ...
            return (
              <li key={item.id} className="relative flex items-center gap-3">
                <div className="min-w-0 flex-1">
                  <div
                    className={cn(
                      'flex items-center justify-between gap-3 rounded-2xl border bg-surface p-3 transition-colors duration-slow',
