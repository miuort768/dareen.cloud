                ...
                {kids.map((child) => {
                    ...
                    return (
                        <button
                            key={child.id}
                            onClick={() => navigate('/parent-students')}
                            className="w-full flex items-center gap-3 p-3 bg-surface dark:bg-surface rounded-lg border border-border dark:border-primary/20 text-end transition-all duration-200 hover:bg-hover dark:hover:bg-primary/5 active:scale-[0.98] hover:shadow-sm"
                        >
                            ...
                            <div className="shrink-0 flex flex-col items-center">
                                <div className="relative w-9 h-9">
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center">
                                         <span className="text-[11px] font-bold text-main dark:text-main">{progress}%</span>
                                    </div>
                                </div>
                            </div>
                        </button>
