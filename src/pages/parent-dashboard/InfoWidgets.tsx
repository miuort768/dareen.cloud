...
export const ParentNotesSection = ({ children }: NotesSectionProps) => {
    if (!children.some((child: any) => child.enrollments?.some((en: any) => en.nextSessionNotes))) return null;
    return (
        <div className="bg-card border border-border rounded-card p-4 md:p-5 shadow-soft">
            ...
            <div className="space-y-3">
                {children.filter((child: any) => child.enrollments?.some((en: any) => en.nextSessionNotes)).map((child: any) => (
