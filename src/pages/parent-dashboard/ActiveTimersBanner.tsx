                    ...
                    <div key={session.id} className="bg-card border border-border rounded-2xl p-4">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-xl bg-warning-soft flex items-center justify-center ring-1 ring-warning/20 animate-pulse">
                            ...
                            <div className="text-xl font-bold font-mono tracking-widest text-main">
