  ...
  return (
    <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
      <button
        ...
        className="flex items-center gap-3 rounded-none border border-border bg-surface p-3.5 text-start transition-all duration-200 hover:bg-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus active:scale-[0.99]"
        aria-label="فتح سجل الدفعات"
      >
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-none bg-success-soft">
      ...
      {whatsappHref ? (
        ...
        >
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-none bg-info-soft">
            <LifeBuoy size={16} className="text-info" />
          </div>
          <span className="min-w-0 flex-1 text-xs font-black text-main">الدعم والاستفسار</span>
        </a>
      ) : (
        <div className="flex items-center gap-3 rounded-none border border-dashed border-border p-3.5 opacity-60">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-none bg-divider">
