    ...
    return (
        <div className="min-h-full pb-24 overflow-x-hidden relative" dir="rtl">
            ...
            <div className="relative z-10 max-w-5xl xl:max-w-6xl 2xl:max-w-7xl mx-auto px-3 sm:px-4 mb-4 sm:mb-6">
                {/* Premium Header Card */}
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary via-indigo-600 to-purple-700 shadow-xl shadow-primary/25">
                    ...
                    <div className="relative p-4 sm:p-5 md:p-6 lg:p-8">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 sm:gap-4 md:gap-5">
                            <div className="flex items-center gap-3 sm:gap-4">
                                <div className="w-10 sm:w-12 md:w-14 h-10 sm:h-12 md:h-14 rounded-xl bg-white/15 backdrop-blur-sm flex items-center justify-center shrink-0 shadow-inner">
                            ...
                            <div className="relative w-full md:w-auto md:min-w-[280px] lg:min-w-[320px]">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/15 backdrop-blur-sm border border-white/20 rounded-xl py-3 sm:py-3.5 md:py-4 ps-9 sm:ps-10 pe-3 sm:pe-4 text-xs sm:text-sm text-white placeholder:text-white/40 focus:outline-none focus:border-white/40 focus:ring-2 focus:ring-white/15 min-h-[44px] transition-all duration-200"
                                />
                            </div>
                        </div>
                    </div>
            ...
            <div className="relative z-10 max-w-5xl xl:max-w-6xl 2xl:max-w-7xl mx-auto px-3 sm:px-4 space-y-3 sm:space-y-4">
                {loading ? (
                    <div className="space-y-3 sm:space-y-4">
                        {[1, 2, 3].map(i => (
                            <div key={i} className="bg-white/70 dark:bg-card/70 backdrop-blur-sm h-24 sm:h-28 md:h-32 animate-pulse border border-border/30 shadow-soft rounded-2xl" />
                        ))}
                    </div>
                ) : filtered.length === 0 ? (
                    <motion.div
                        ...
                        className="bg-white/70 dark:bg-card/70 backdrop-blur-sm border border-border/30 shadow-soft rounded-2xl p-8 sm:p-10 md:p-12 lg:p-16 text-center"
                    >
                        <div className="w-14 sm:w-16 h-14 sm:h-16 rounded-2xl bg-gradient-to-br from-primary-soft to-primary/10 flex items-center justify-center mx-auto mb-4 sm:mb-5">
                        ...
                        <AnimatePresence>
                            {filtered.map(msg => (
                                <motion.div
                                    ...
                                    className="group bg-white/70 dark:bg-card/70 backdrop-blur-sm border border-border/30 shadow-soft hover:shadow-md hover:border-primary/20 transition-all duration-300 overflow-hidden rounded-2xl"
                                >
                                    ...
                                    <div className="p-4 sm:p-5 md:p-6 lg:p-8 relative z-10">
                                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 sm:gap-0 mb-3 sm:mb-4">
                                            <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                                                <div className="w-8 sm:w-9 md:w-10 h-8 sm:h-9 md:h-10 rounded-xl bg-gradient-to-br from-primary-soft to-primary/5 flex items-center justify-center shrink-0">
                                            ...
                                            <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap shrink-0">
                                                <a href={`tel:${msg.phone}`}
                                                    className="inline-flex items-center justify-center gap-1 sm:gap-1.5 px-2 sm:px-1.5 md:px-3 py-2 sm:py-1.5 md:py-2 rounded-xl text-emerald-600 bg-emerald-50/80 dark:bg-emerald-900/20 dark:text-emerald-400 hover:bg-emerald-100 dark:hover:bg-emerald-900/30 transition-all duration-200 text-xs font-bold min-w-[44px] min-h-[44px] md:min-h-0 shadow-sm hover:shadow-md hover:shadow-emerald-200/30 active:scale-95"
                                                ...
                                                <button type="button" onClick={() => handleDelete(msg.id)}
                                                    className="inline-flex items-center justify-center gap-1 sm:gap-1.5 px-2 sm:px-1.5 md:px-3 py-2 sm:py-1.5 md:py-2 rounded-xl text-rose-600 bg-rose-50/80 dark:bg-rose-900/20 dark:text-rose-400 hover:bg-rose-100 dark:hover:bg-rose-900/30 transition-all duration-200 text-xs font-bold min-w-[44px] min-h-[44px] md:min-h-0 shadow-sm hover:shadow-md hover:shadow-rose-200/30 active:scale-95"
                                        ...
                                        <div className="bg-white/40 dark:bg-black/20 backdrop-blur-sm p-3 sm:p-4 md:p-5 rounded-xl mb-3 border border-border/20">
                                        ...
                                        <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
                                            <span className="inline-flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 rounded-xl bg-emerald-50/80 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 border border-emerald-200/50 dark:border-emerald-800/30 text-[11px] sm:text-xs shadow-sm">
                                                <span className="truncate max-w-[120px] sm:max-w-none">{msg.phone}</span>
                                                <Phone size={11} className="sm:size-[12px]" />
                                            </span>
                                            <span className="inline-flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 rounded-xl bg-indigo-50/80 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 border border-indigo-200/50 dark:border-indigo-800/30 text-[11px] sm:text-xs shadow-sm">
                                                <span className="truncate max-w-[100px] sm:max-w-none">{msg.curriculum || '-'}</span>
                                                <BookOpen size={11} className="sm:size-[12px]" />
                                            </span>
                                            <span className="inline-flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 rounded-xl bg-sky-50/80 dark:bg-sky-900/20 text-sky-600 dark:text-sky-400 border border-sky-200/50 dark:border-sky-800/30 text-[11px] sm:text-xs shadow-sm">
