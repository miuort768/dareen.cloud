    ...
    return (
        <div className="space-y-6 pb-20 animate-in fade-in duration-500" dir="rtl">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-medium text-gray-900 dark:text-white tracking-tight">سجل الحضور والغياب</h1>
                    <p className="text-sm text-gray-500 font-normal dark:text-gray-400">متابعة دقيقة لحضور وانصراف الأبناء في الحصص</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <div className="lg:col-span-1 space-y-4">
                    <div className="bg-gray-900 p-6 text-white border-r-4 border-r-emerald-500">
                        ...
                        <h4 className="text-[10px] font-medium text-gray-400 uppercase tracking-widest">إجمالي الحضور</h4>
                    ...
                    <div className="bg-gray-900 p-6 text-white border-r-4 border-r-rose-500">
                        ...
                        <h4 className="text-[10px] font-medium text-gray-400 uppercase tracking-widest">إجمالي الغياب</h4>
                        <div className="text-3xl font-medium mt-1">
                ...
                <div className="lg:col-span-3">
                    <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
                        <div className="p-4 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
                            <h4 className="font-medium text-[10px] text-gray-400 uppercase tracking-widest">التاريخ والسجل الزمني</h4>
                            ...
                            <table className="w-full text-right">
                                ...
                                <tbody className="divide-y divide-gray-50 dark:divide-gray-800">
                                                ...
                                                <div className="flex justify-center">
                                                    {session.status === 'completed' ? (
                                                        <div className="flex items-center gap-2 px-3 py-1 bg-emerald-50 text-emerald-700 border border-emerald-100 dark:bg-emerald-900/20 dark:text-emerald-400 dark:border-emerald-800">
                                                            ...
                                                            <span className="text-[10px] font-medium uppercase tracking-widest">حضر</span>
                                                        </div>
                                                    ) : (
                                                        <div className="flex items-center gap-2 px-3 py-1 bg-rose-50 text-rose-700 border border-rose-100 dark:bg-rose-900/20 dark:text-rose-400 dark:border-rose-800">
                                                            <XCircle size={12} />
                                                            <span className="text-[10px] font-medium uppercase tracking-widest">غائب / مُلغى</span>
                                                        </div>
                                                    )}
                                                </div>
                                            </td>
                                    ...
                                    {filteredSessions.length === 0 && (
                                        <tr>
                                            <td colSpan={3} className="px-6 py-12 text-center text-gray-400 font-normal uppercase text-[10px] tracking-widest italic">لا توجد سجلات حضور متاحة حالياً</td>
                                        </tr>
                                    )}
                                </tbody>
                            </table>
