    ...
    return (
        <div className="space-y-6 pb-20 animate-in fade-in duration-500" dir="rtl">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-medium text-main dark:text-on-primary tracking-tight">��� ������ �������</h1>
                    <p className="text-sm text-muted font-normal dark:text-muted">������ ����� ����� ������� ������� �� �����</p>
                </div>
                ...
                <div className="lg:col-span-3">
                    <div className="bg-white dark:bg-card border border-border dark:border-border shadow-sm overflow-hidden">
                        <div className="p-4 bg-background dark:bg-card/50 border-b border-border dark:border-border flex items-center justify-between">
                            <h4 className="font-medium text-micro text-muted uppercase tracking-widest">������� ������ ������</h4>
                            ...
                            <table className="w-full text-right">
                                ...
                                <tbody className="divide-y divide-border dark:divide-border">
                                    {filteredSessions.map((session) => (
                                        <tr key={session.id} className="hover:bg-surface dark:hover:bg-card/50 transition-colors group">
                                            <td className="px-6 py-4">
                                                ...
                                                <div className="text-micro text-muted font-medium uppercase tracking-tighter">{session.subject}</div>
                                            </td>
                                            <td className="px-6 py-4">
                                                <div className="flex flex-col items-center">
                                                    ...
                                                    <div className="flex items-center gap-1 mt-1">
                                                        ...
                                                        <span className="text-micro text-muted font-normal">{session.time}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="px-6 py-4">
                                                <div className="flex justify-center">
                                                    {session.status === 'completed' ? (
                                                        <div className="flex items-center gap-2 px-3 py-1 bg-success-light text-success border border-success dark:bg-success/20 dark:text-success dark:border-success">
                                                            ...
                                                            <span className="text-micro font-medium uppercase tracking-widest">���</span>
                                                        </div>
                                                    ) : (
                                    ...
                                    {filteredSessions.length === 0 && (
                                        <tr>
                                            <td colSpan={3} className="px-6 py-12 text-center text-muted font-normal uppercase text-micro tracking-widest italic">�� ���� ����� ���� ����� ������</td>
                                        </tr>
                                    )}
                                </tbody>
                            </table>
