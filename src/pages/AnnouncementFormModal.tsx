                        ...
                        <div>
                            ...
                            <div className="flex gap-1 h-11">
                                <button type="button" onClick={() => onChange({ isActive: true })}
                                    className={cn("flex-1 font-bold text-micro rounded-xl transition-all active:scale-95", formData.isActive ? "bg-success text-on-success shadow-sm" : "bg-surface dark:bg-card text-dim dark:text-muted")}>
                                    نشط
                                </button>
                                <button type="button" onClick={() => onChange({ isActive: false })}
                                    className={cn("flex-1 font-bold text-micro rounded-xl transition-all active:scale-95", !formData.isActive ? "bg-warning text-on-warning shadow-sm" : "bg-surface dark:bg-card text-dim dark:text-muted")}>
                                    مخفي
                                </button>
                            </div>
                        </div>
