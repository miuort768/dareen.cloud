...
export const TeacherDashboard = () => {
    ...
    if (!currentUser || currentUser.role !== 'teacher') return <div className="min-h-full bg-surface dark:bg-black font-sans" />;
    ...
    return (
        <>
            <div className="hidden md:block min-h-full pb-24 overflow-x-hidden relative bg-background dark:bg-black font-sans transition-colors duration-500" dir="rtl">
