...
export const Reports = () => {
    ...
    return (
        <div className="min-h-full pb-24 overflow-x-hidden relative bg-gradient-to-br from-slate-50 via-white to-slate-50/30 dark:from-[#020617] dark:via-slate-950 dark:to-slate-950/20 font-dash" dir="rtl">
