                    ...
                    <div className="flex flex-col items-center justify-center py-4 px-6 bg-primary border border-primary/20 mb-4 relative overflow-hidden group rounded-card shadow-xl shadow-primary/20">
                        ...
                        <div className="relative z-10 text-center">
                            ...
                            <a
                                ...
                                className="inline-flex items-center justify-center gap-4 bg-white text-primary hover:bg-white/90 px-6 py-3 w-full sm:w-auto rounded-card font-bold transition-all group relative overflow-hidden shadow-lg border border-white/20"
                            >
