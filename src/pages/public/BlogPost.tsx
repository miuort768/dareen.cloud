        ...
        <div className="min-h-full bg-white dark:bg-slate-950 font-sans text-gray-800 dark:text-slate-100 relative flex flex-col">
            ...
            <main className="flex-grow pt-3 md:pt-32 pb-8 md:pb-20 relative">
                ...
                <article className="container mx-auto px-4 max-w-3xl">
                    <div 
                        className="prose sm:prose-lg dark:prose-invert prose-headings:font-heading prose-headings:font-black prose-a:text-red-600 prose-img:shadow-xl max-w-none prose-p:text-center text-[#7F09C8] dark:text-[#179013]"
                        ...
                        <div className="flex flex-wrap gap-3 my-8 justify-center">
                            {post.downloadLink && (
                                <button onClick={(e) => handleButtonClick('download', post.downloadLink!, e)}
                                    ...
                                    className={`flex-1 inline-flex items-center justify-center gap-2 px-6 md:px-16 py-3 md:py-4 font-black text-[11px] sm:text-sm rounded-xl hover:bg-red-600 dark:hover:bg-red-500 hover:text-white transition-all shadow-lg disabled:opacity-50 disabled:cursor-not-allowed ${buttonState?.type === 'download' && buttonState.phase === 'counting' ? 'bg-[#057022] text-white' : buttonState?.type === 'download' && buttonState.phase === 'ready' ? 'bg-[#047857] text-white ring-2 ring-[#047857] ring-offset-2' : 'bg-gray-900 dark:bg-[#B31768] text-white dark:text-white'}`}>
                                    <Download size={16} />
                    ...
                    {contentParts.rest && (
                        <div 
                            className="prose sm:prose-lg dark:prose-invert prose-headings:font-heading prose-headings:font-black prose-a:text-red-600 prose-img:shadow-xl max-w-none mb-0 prose-p:text-center"
