        ...
        <div className="min-h-full bg-white dark:bg-slate-950 font-sans text-gray-800 dark:text-slate-100 relative flex flex-col">
            ...
            <main className="flex-grow pt-3 md:pt-32 pb-6 md:pb-10 relative">
                ...
                <div className="container mx-auto px-4 max-w-5xl mb-12">
                    <div className="w-full aspect-[2/1] md:aspect-[3/1] bg-gray-100 dark:bg-slate-900 rounded-xl overflow-hidden shadow-xl flex items-center justify-center">
                        <img src={post.coverImage} alt={post.title} loading="lazy" decoding="async" className="w-full h-full object-contain" />
                    </div>
                </div>
