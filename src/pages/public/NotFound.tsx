...
export const NotFound = () => {
    return (
        <div className="min-h-full bg-background dark:bg-background font-sans text-main dark:text-main relative flex flex-col">
            ...
            <main className="flex-grow pt-4 md:pt-20 pb-4 relative flex items-center justify-center">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center max-w-lg">
                    <img src="/404.png" alt="404" className="w-80 md:w-[480px] mx-auto mb-0 md:mb-4 block object-contain max-h-64 md:max-h-96" />
