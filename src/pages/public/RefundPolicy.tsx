                ...
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <div className="flex flex-col items-center justify-center py-6 px-6 bg-primary dark:bg-background border border-primary dark:border-border mb-4 relative overflow-hidden group rounded-card shadow-xl shadow-primary/20">
                        ...
                        <div className="relative z-10 text-center">
                            <h2 className="text-2xl font-black text-on-primary dark:text-white mb-2">تحتاج مساعدة بخصوص طلبك؟</h2>
                            <p className="text-micro md:text-base text-on-primary dark:text-white mb-8 max-w-md mx-auto whitespace-nowrap md:whitespace-normal">فريق الحسابات متاح للرد على استفساراتكم المالية فوراً</p>
