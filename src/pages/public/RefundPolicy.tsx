                        ...
                        <div className="flex items-start gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-sm md:text-base text-gray-600 leading-relaxed">
                                    في معهد دارين، نسعى لتقديم خدمة تعليمية متميزة. تهدف هذه السياسة إلى ضمان الشفافية والعدالة لكل من الطالب والمعهد فيما يخص الرسوم المدفوعة وإجراءات الإلغاء.
                                </p>
                            </div>
                        </div>
                    </div>
