                ...
                >
                  <Quote
                    ...
                    className={cn(
                      ...
                      isLarge
                        ? 'text-on-success opacity-10 dark:text-muted'
                        : 'text-primary opacity-5 group-hover:text-primary/15 dark:text-primary dark:group-hover:text-accent',
                    )}
                  />
                  ...
                  {!isLarge && (
                    <div className="absolute bottom-0 end-0 h-8 w-8 border-b-2 border-e-2 border-transparent transition-all duration-700 group-hover:border-primary/20 dark:group-hover:border-accent-soft"></div>
                  )}
                </div>
              )
            })}
