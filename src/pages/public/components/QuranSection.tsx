...
const LeafDecoration = () => (
    <div className="absolute top-0 end-0 w-48 h-48 md:w-64 md:h-64 pointer-events-none overflow-hidden opacity-60">
                            ...
                            <div className="w-full lg:w-1/2 text-center">
                                ...
                                <h2 className="text-lg sm:text-2xl lg:text-3xl font-black mb-4 text-main leading-tight font-heading">
                                    رحلتك مع <span className="text-success relative inline-block">
                                        كتاب الله
                                        <svg className="absolute -bottom-2 start-0 w-full h-3" viewBox="0 0 100 10" preserveAspectRatio="none">
                    ...
                    <div className="text-center mb-5">
                        <h2 className="text-2xl leading-[1.2] font-black text-main font-heading">
                            ...
                            <span className="text-success relative inline-block">
                                كتاب الله
                                <svg className="absolute -bottom-1.5 start-0 w-full h-3" viewBox="0 0 120 12" preserveAspectRatio="none">
