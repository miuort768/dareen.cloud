        ...
        <>
            ...
            <section className="hidden md:block pt-4 md:pt-6 pb-6 relative overflow-hidden bg-surface dark:bg-background transition-colors duration-500">
                ...
                <div className="container mx-auto px-4 md:px-8 relative z-10">
                    <div className="max-w-6xl mx-auto bg-success-soft dark:bg-surface border border-success dark:border-primary/40 rounded-2xl shadow-sm overflow-hidden">
                        <div className="flex flex-col lg:flex-row items-center gap-4 lg:gap-16 justify-center p-6 md:p-10">
                            <div className="w-full lg:w-1/2 text-center">
                                <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/80 dark:bg-primary/15 border border-success/50 dark:border-primary/40 rounded-full mb-4 mx-auto">
                                    ...
                                    <span className="text-success-dark dark:text-primary font-bold text-xs">»—«„Ã  Õ›ÌŸ „ „Ì“…</span>
                                </div>
                                <h2 className="text-lg sm:text-2xl lg:text-3xl font-black mb-4 text-main dark:text-main leading-tight font-heading">
                                    —Õ· ﬂ „⁄ <span className="text-success dark:text-primary relative inline-block">
                                        ﬂ «» «··Â
                                ...
                                <p className="text-muted dark:text-muted text-xs lg:text-sm leading-relaxed mb-6 max-w-xl mx-auto font-medium">
                                    „‰ÂÃÌ… ›—Ìœ…  Ã„⁄ »Ì‰ √’«·… «· ·ﬁÌ Ê ﬁ‰Ì«  «· ⁄·Ì„ «·ÕœÌÀ…. ‰ﬁœ„ Õ·ﬁ«  ›—œÌ… Ê„Ã„Ê⁄«  ’€Ì—… „⁄ ‰Œ»… „‰ «·„ﬁ—∆Ì‰ «·„Ã«“Ì‰.
                                </p>
                                <div className="flex flex-col sm:flex-row gap-3 justify-center mb-5">
                                    <a
                                        href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent('«·”·«„ ⁄·Ìﬂ„° √—€» ›Ì «·»œ¡ »Õ›Ÿ «·ﬁ—¬‰ «·ﬂ—Ì„ ›Ì œ«—Ì‰ «·”«»⁄…')}`}
                                        target="_blank"
                                ...
                                <div className="items-center justify-center gap-4 inline-flex">
                                    ...
                                    <div className="text-start">
                                        ...
                                        <div className="text-xs text-muted dark:text-muted font-medium">„‰ ﬁ»· ¬·«› «·ÿ·«»</div>
                                    </div>
                                </div>
                            </div>
                            <div className="w-full lg:w-1/2 flex justify-center py-4 lg:py-0">
                                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-50px' }} variants={{ visible: { transition: { staggerChildren: 0.1 } } }} className="grid grid-cols-2 gap-3 w-full max-w-[400px]">
                                    <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} transition={{ duration: 0.4 }} className="p-4 bg-card dark:bg-hover border border-border dark:border-primary/25 rounded-2xl shadow-sm flex flex-col items-center text-center">
                                        ...
                                        <h3 className="font-black text-main dark:text-main text-xs mb-1">√Êﬁ«  „—‰…</h3>
                                        <p className="text-micro text-muted dark:text-muted leading-tight font-medium">«Œ — „Ê«⁄Ìœﬂ «·„›÷·…</p>
                                    </motion.div>
                                    <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} transition={{ duration: 0.4 }} className="p-4 bg-card dark:bg-hover border border-border dark:border-primary/25 rounded-2xl shadow-sm flex flex-col items-center text-center">
                                        ...
                                        <h3 className="font-black text-main dark:text-main text-xs mb-1">„ «»⁄… œﬁÌﬁ…</h3>
                                        <p className="text-micro text-muted dark:text-muted leading-tight font-medium"> ﬁ«—Ì— ≈‰Ã«“ √”»Ê⁄Ì…</p>
                                    </motion.div>
                                    <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} transition={{ duration: 0.4 }} className="p-4 bg-card dark:bg-hover border border-border dark:border-primary/25 rounded-2xl shadow-sm flex flex-col items-center text-center">
                                        ...
                                        <h3 className="font-black text-main dark:text-main text-xs mb-1">„⁄·„Ê‰ „Ã«“Ê‰</h3>
                                        <p className="text-micro text-muted dark:text-muted leading-tight font-medium">‰Œ»… «·Õ›«Ÿ «·„»œ⁄Ê‰</p>
                                    </motion.div>
                                    <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} transition={{ duration: 0.4 }}>
                                        <Link to="/contact" className="p-4 bg-primary dark:bg-gradient-to-r dark:from-primary dark:to-warning rounded-2xl shadow-lg text-on-primary dark:text-on-primary flex flex-col items-center text-center transition-all hover:brightness-90 cursor-pointer">
                                            ...
                                            <h3 className="font-black text-on-primary dark:text-on-primary text-xs mb-1">Ã—» „Ã«‰«</h3>
                                            <p className="text-on-primary dark:text-on-primary opacity-80 text-micro leading-tight font-extrabold">Õ’…  Ã—Ì»Ì… ··„‘ —ﬂÌ‰</p>
                                        </Link>
                                    </motion.div>
                                </motion.div>
                            </div>
                ...
                <div className="relative z-10 px-5">
                    <div className="flex items-center justify-center mb-5 mt-2">
                        <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/80 dark:bg-primary/15 border border-success dark:border-primary/40 rounded-full shadow-sm">
                            <span className="w-2 h-2 rounded-full bg-success dark:bg-primary animate-pulse"></span>
                            <span className="text-success-dark dark:text-primary font-bold text-xs tracking-wide">»—«„Ã Õ›Ÿ „ „Ì“…</span>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-center gap-4 mb-8">
                        <div className="text-end">
                            ...
                            <div className="text-xs text-muted dark:text-muted font-medium mt-0.5">„‰ ﬁ»· ¬·«› «·ÿ·«»</div>
                        </div>
                    ...
                    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-40px' }} variants={{ visible: { transition: { staggerChildren: 0.08 } } }} className="grid grid-cols-2 gap-3 mb-8 max-w-[360px] mx-auto">
                        <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} transition={{ duration: 0.4 }} className="bg-card dark:bg-hover border border-border dark:border-primary/25 rounded-2xl p-4 shadow-sm flex flex-col items-center text-center">
                            ...
                            <h3 className="font-black text-main dark:text-main text-sm mb-1">„ «»⁄… œﬁÌﬁ…</h3>
                            <p className="text-muted dark:text-muted text-micro leading-relaxed"> ﬁ«—Ì— ≈‰Ã«“ √”»Ê⁄Ì…</p>
                        </motion.div>
                        <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} transition={{ duration: 0.4 }} className="bg-card dark:bg-hover border border-border dark:border-primary/25 rounded-2xl p-4 shadow-sm flex flex-col items-center text-center">
                            ...
                            <h3 className="font-black text-main dark:text-main text-sm mb-1">√Êﬁ«  „—‰…</h3>
                            <p className="text-muted dark:text-muted text-micro leading-relaxed">«Œ — „Ê«⁄Ìœﬂ «·„›÷·…</p>
                        </motion.div>
                        <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} transition={{ duration: 0.4 }} className="bg-primary dark:bg-gradient-to-r dark:from-primary dark:to-warning border-0 rounded-2xl p-4 shadow-lg flex flex-col items-center text-center">
                            ...
                            <h3 className="font-black text-on-primary dark:text-on-primary text-sm mb-1">Ã—» „Ã«‰«</h3>
                            <p className="text-on-primary dark:text-on-primary opacity-80 text-micro leading-relaxed font-bold">Õ’…  Ã—Ì»Ì… ··„‘ —ﬂÌ‰</p>
                        </motion.div>
                        <motion.div variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }} transition={{ duration: 0.4 }} className="bg-card dark:bg-hover border border-border dark:border-primary/25 rounded-2xl p-4 shadow-sm flex flex-col items-center text-center">
                            ...
                            <h3 className="font-black text-main dark:text-main text-sm mb-1">„⁄·„Ê‰ „Ã«“Ê‰</h3>
                            <p className="text-muted dark:text-muted text-micro leading-relaxed">‰Œ»… «·Õ›«Ÿ «·„»œ⁄Ê‰</p>
                        </motion.div>
                    </motion.div>
