    ...
    const steps = [
        {
            ...
            icon: Users,
            title: 'اختر الخدمة',
            desc: 'اختر المادة والمرحلة الدراسية (رياضيات، علوم، لغة عربية، إنجليزية، تحفيظ قرآن) من مناهج الكويت والخليج',
        ...
        },
        {
            ...
            icon: Star,
            title: 'حصص مجانية',
            desc: 'احصل على حصة تجريبية مجانية مع أحد معلمينا الخبراء لتقييم مستوى الطالب',
        ...
        },
        {
            ...
            icon: Sparkles,
            title: 'اشترك الآن',
            desc: 'اشترك في الباقة المناسبة وابدأ رحلة التفوق الدراسي مع متابعة أسبوعية وتقارير دورية',
