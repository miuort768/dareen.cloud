...
import { Play, ArrowLeft, Star, BadgeCheck } from 'lucide-react';
                    ...
                    <div className="max-w-6xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-2 lg:gap-6">
                        <div className="lg:w-[60%] text-center z-10">
                            ...
                            <h1 className="text-3xl sm:text-4xl lg:text-6xl font-heading font-black text-slate-900 dark:text-white leading-none mb-0 relative">
                                ...
                                <span className="block mb-0 min-h-[1.1em] aria-hidden">{typewriterText || '\u00A0'}<BadgeCheck className="w-5 h-5 inline-block text-blue-500 mr-1 -mt-0.5" /><span className="inline-block animate-pulse border-r-4 border-indigo-600 dark:border-white ml-1 h-[0.9em] align-middle"></span></span>
