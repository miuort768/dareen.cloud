          ...
          <div className="mt-6 p-5 bg-gradient-to-br from-primary to-primary-hover dark:from-card dark:via-primary-soft dark:to-card dark:border dark:border-primary/30 rounded-3xl relative overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-white/10 dark:bg-primary/20 border border-white/10 dark:border-primary/30 rounded-full mb-3">
                ...
                <span className="text-micro font-bold text-on-primary dark:text-primary opacity-90">التميز التعليمي</span>
              </div>
              <h3 className="text-lg font-black text-on-primary dark:text-main font-heading mb-2">بيئة تعليمية متطورة</h3>
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              <div className="p-3 bg-white/5 dark:bg-primary/10 border border-white/10 dark:border-primary/20 rounded-xl text-center">
                ...
                <div className="text-micro text-on-primary dark:text-muted font-bold">سنوات خبرة</div>
              </div>
              <div className="p-3 bg-white/5 dark:bg-primary/10 border border-white/10 dark:border-primary/20 rounded-xl text-center">
                ...
                <div className="text-micro text-on-primary dark:text-muted font-bold">معلم خبير</div>
              </div>
            </div>
          </div>
        </motion.div>
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center gap-6">
              <div className="flex-1 text-center lg:text-start">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/15 dark:bg-primary/20 border border-white/20 dark:border-primary/30 rounded-full mb-3 mx-auto lg:mx-0">
                  ...
                  <span className="text-xs font-bold text-on-primary dark:text-primary">التميز التعليمي</span>
                </div>
                <h3 className="text-xl md:text-2xl font-black mb-2 font-heading text-on-primary dark:text-main">بيئة تعليمية متطورة</h3>
                <p className="text-on-primary dark:text-muted text-xs md:text-sm leading-relaxed max-w-xl mx-auto lg:mx-0 font-medium">نخبة من المعلمين المبدعين لتدريس المناهج الكويتية والخليجية. تعليم عن بعد، تحفيظ قرآن، وتأسيس في الرياضيات والعلوم واللغة العربية والإنجليزية.</p>
              </div>
              <div className="grid grid-cols-2 gap-4 sm:gap-6 w-full lg:w-auto shrink-0">
                <div className="p-6 bg-white/10 dark:bg-primary/10 border border-white/10 dark:border-primary/20 rounded-2xl text-center group-hover:bg-white/15 dark:group-hover:bg-[#D4AF37]/20 transition-all duration-300">
                  ...
                  <div className="text-xs text-on-primary dark:text-muted font-bold">معلم خبير</div>
                </div>
                <div className="p-6 bg-white/10 dark:bg-primary/10 border border-white/10 dark:border-primary/20 rounded-2xl text-center group-hover:bg-white/15 dark:group-hover:bg-[#D4AF37]/20 transition-all duration-300">
                  ...
                  <div className="text-xs text-on-primary dark:text-muted font-bold">سنوات خبرة</div>
                </div>
              </div>
            </div>
          </div>
