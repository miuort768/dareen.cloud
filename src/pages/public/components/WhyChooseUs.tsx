...
const features = [
  ...
  },
  {
    ...
    desc: 'دروس خصوصية تفاعلية للمناهج الكويتية والسعودية والقطرية في الرياضيات والعلوم واللغة العربية والإنجليزية تنمي مهارات الفهم والتفكير الإبداعي.',
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8">
        ...
        <div className="text-center mb-4 md:mb-6">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm md:text-base max-w-4xl mx-auto leading-relaxed font-medium md:whitespace-nowrap">
            أفضل منصة تعليم عن بعد في السعودية، الكويت، الإمارات، قطر وعمان والبحرين. دروس خصوصية، قدرات وتحصيلي، تحفيظ قرآن، وتأسيس للمناهج السعودية والقطرية والعمانية والبحرينية والخليجية في الرياض وجدة والكويت ودبي والدوحة والريان ومسقط وصلالة والمنامة مع نخبة المعلمين.
          </p>
        </div>
