...
const features = [
  {
    title: 'д «∆ћ г÷гжд…',
    desc: 'г «»Џ… ѕёнё… гЏ  ё«—н— √”»жЏн… б Ќ”нд г” жм «бЎ«б».',
    variant: 'success' as const,
  },
  {
    title: 'Ў—ё  Џбнг г» я—…',
    desc: 'ѕ—ж” ќ’ж’н…  Ё«Џбн… ббгд«ећ «бќбнћн…  дгн ге«—«  «бЁег ж«б Ёян— «б≈»ѕ«Џн.',
    variant: 'primary' as const,
  },
  {
    title: '»н∆… ¬гд… жгЌЁ“…',
    desc: 'Ё’жб «Ё —«÷н… ¬гд… бѕ—ж” «б ёжн… √ждб«нд гЏ дќ»… гЏбгн «б—н«÷н«  ж«бЏбжг ж«ббџ… «бЏ—»н….',
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8">
        ...
        <div className="text-center mb-4 md:mb-6">
          ...
          <p className="text-muted dark:text-muted text-sm md:text-base lg:text-xs max-w-4xl mx-auto leading-relaxed font-medium">
            <span className="hidden md:inline">√Ё÷б гд’…  Џбнг Џд »Џѕ Ён «б”Џжѕн…° «бяжн ° «б≈г«—« ° ёЎ— жЏг«д ж«б»Ќ—нд.<br />ѕ—ж” ќ’ж’н…° ёѕ—«  ж Ќ’нбн°  ЌЁнў ё—¬д° ж √”н” ббгд«ећ «бќбнћн… гЏ дќ»… «бгЏбгнд.</span>
            <span className="md:hidden">√Ё÷б гд’…  Џбнг Џд »Џѕ Ён «б”Џжѕн…° «бяжн ° «б≈г«—« ° ёЎ— жЏг«д ж«б»Ќ—нд. ѕ—ж” ќ’ж’н…° ёѕ—«  ж Ќ’нбн°  ЌЁнў ё—¬д° ж √”н” ббгд«ећ «бќбнћн… гЏ дќ»… «бгЏбгнд.</span>
          </p>
        </div>
          ...
          <div className="mt-6 p-5 bg-gradient-to-br from-primary to-primary-hover dark:from-card dark:via-primary-soft dark:to-card dark:border dark:border-primary/30 rounded-3xl relative overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-white/10 dark:bg-primary/20 border border-white/10 dark:border-primary/30 rounded-full mb-3">
                ...
                <span className="text-micro font-bold text-on-primary dark:text-primary opacity-90">«б гн“ «б Џбнгн</span>
              </div>
              <h3 className="text-lg font-black text-on-primary dark:text-main font-heading mb-2">»н∆…  Џбнгн… г Ўж—…</h3>
              <p className="text-micro text-on-primary dark:text-muted opacity-90 leading-relaxed mb-4 max-w-xs mx-auto font-medium">
                дќ»… гд «бгЏбгнд «бг ќ’’нд Ён  ѕ—н” «бгд«ећ «бяжн н… ж«бќбнћн… б÷г«д  Ёжё ЎЁбя Ён «б—н«÷н«  ж«бЏбжг ж«ббџ« .
              </p>
              <a
                href={`https://wa.me/${whatsappNumber.replace(/\D/g, '')}?text=${encodeURIComponent('«б”б«г Џбняг° √—џ» Ён «б»ѕЅ »—Ќб… «б гн“ «б Џбнгн…')}`}
                target="_blank"
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              <div className="p-3 bg-white/5 dark:bg-primary/10 border border-white/10 dark:border-primary/20 rounded-xl text-center">
                ...
                <div className="text-micro text-on-primary dark:text-muted font-bold">”дж«  ќ»—…</div>
              </div>
              <div className="p-3 bg-white/5 dark:bg-primary/10 border border-white/10 dark:border-primary/20 rounded-xl text-center">
                ...
                <div className="text-micro text-on-primary dark:text-muted font-bold">гЏбг ќ»н—</div>
              </div>
            </div>
          </div>
        </motion.div>
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center gap-6">
              <div className="flex-1 text-center lg:text-start">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/15 dark:bg-primary/20 border border-white/20 dark:border-primary/30 rounded-full mb-3 mx-auto lg:mx-0">
                  ...
                  <span className="text-xs font-bold text-on-primary dark:text-primary">«б гн“ «б Џбнгн</span>
                </div>
                <h3 className="text-xl md:text-2xl font-black mb-2 font-heading text-on-primary dark:text-main">»н∆…  Џбнгн… г Ўж—…</h3>
                <p className="text-on-primary dark:text-muted text-xs md:text-sm leading-relaxed max-w-xl mx-auto lg:mx-0 font-medium">дќ»… гд «бгЏбгнд «бг»ѕЏнд б ѕ—н” «бгд«ећ «бяжн н… ж«бќбнћн….  Џбнг Џд »Џѕ°  ЌЁнў ё—¬д° ж √”н” Ён «б—н«÷н«  ж«бЏбжг ж«ббџ… «бЏ—»н… ж«б≈дћбн“н….</p>
              </div>
              <div className="grid grid-cols-2 gap-4 sm:gap-6 w-full lg:w-auto shrink-0">
                <div className="p-6 bg-white/10 dark:bg-primary/10 border border-white/10 dark:border-primary/20 rounded-2xl text-center group-hover:bg-white/15 dark:group-hover:bg-accent/20 transition-all duration-300">
                  ...
                  <div className="text-xs text-on-primary dark:text-muted font-bold">гЏбг ќ»н—</div>
                </div>
                <div className="p-6 bg-white/10 dark:bg-primary/10 border border-white/10 dark:border-primary/20 rounded-2xl text-center group-hover:bg-white/15 dark:group-hover:bg-accent/20 transition-all duration-300">
                  ...
                  <div className="text-xs text-on-primary dark:text-muted font-bold">”дж«  ќ»—…</div>
                </div>
              </div>
            </div>
          </div>
