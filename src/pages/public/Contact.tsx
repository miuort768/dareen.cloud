    ...
    return (
        <div className="min-h-full bg-background dark:bg-background font-sans text-main dark:text-main flex flex-col">
            ...
            <main className="flex-grow md:pt-28 pb-2 relative overflow-hidden">
                ...
                <div className="absolute top-0 end-0 w-[500px] h-[500px] bg-primary/5 rounded-none blur-[120px] -translate-y-1/2 translate-x-1/3 pointer-events-none" />
                <div className="absolute bottom-0 start-0 w-[400px] h-[400px] bg-success/5 rounded-none blur-[100px] translate-y-1/3 -translate-x-1/3 pointer-events-none" />
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-background dark:bg-card border border-border dark:border-border rounded-none px-4 py-3 text-sm font-bold text-main dark:text-on-primary outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all text-start placeholder:text-dim"
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <select
                                            ...
                                            className="w-full bg-background dark:bg-card border border-border dark:border-border rounded-none px-4 py-3 text-sm font-bold text-main dark:text-on-primary outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all appearance-none bg-[length:14px] bg-no-repeat pe-10"
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full bg-background dark:bg-card border border-border dark:border-border rounded-none px-4 py-3 text-sm font-bold text-main dark:text-on-primary outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all resize-none placeholder:text-dim"
