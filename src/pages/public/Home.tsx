    ...
    return (
        <div className="min-h-full bg-surface dark:bg-background text-main dark:text-main relative overflow-x-hidden transition-colors duration-500">
            ...
            <main className="md:hidden pb-4 px-2 max-w-lg mx-auto relative">
                ...
                <section className="relative bg-gradient-to-br from-primary-light via-primary-soft to-card dark:from-card dark:via-surface dark:to-card rounded-card overflow-hidden mb-4 shadow-sm border border-border/50 dark:border-primary/30">
            ...
            <div className="hidden md:block">
                <AnimateOnScroll animation="scaleIn" duration={0.7}><HeroSection typewriterText={typewriterText} signupNowNumber={signupNowNumber} requestFreeNumber={requestFreeNumber} academyName={academyName} bannersArray={bannersArray} /></AnimateOnScroll>
