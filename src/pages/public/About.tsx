            ...
            <section className="relative pb-8 md:pt-32 md:pb-12 overflow-hidden bg-white dark:bg-slate-950">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    ...
                    <p className="text-xs md:text-base text-gray-500 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed md:leading-relaxed mb-8 px-4 font-medium">
                        في دارين السابعة، منصة تعليم عن بعد رائدة في السعودية والكويت والخليج، نؤمن بأن كل طالب هو مشروع نجاح بحد ذاته. نجمع بين أصالة القيم العربية وأحدث تقنيات التعليم الرقمي في السعودية، الكويت، الإمارات، قطر وعمان والبحرين لتقديم دروس خصوصية أونلاين في الرياض وجدة والكويت ودبي والدوحة والريان ومسقط وصلالة والمنامة، قدرات وتحصيلي، تحفيظ قرآن، وتأسيس أطفال وفق المناهج السعودية والقطرية والعمانية والبحرينية والخليجية.
                    </p>
