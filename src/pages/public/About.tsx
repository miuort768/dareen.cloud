        ...
        <div className="min-h-full bg-white dark:bg-slate-950 font-sans text-gray-800 dark:text-slate-100 relative overflow-x-hidden">
            ...
            <section className="py-16 bg-[#fafafa] dark:bg-slate-900/50 relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-red-600/5 border border-red-600/10 mb-6">
                            <span className="text-[10px] font-black uppercase tracking-widest text-red-600">دستورنا التعليمي</span>
                        </div>
                        <h2 className="text-3xl md:text-5xl font-black text-gray-900 mb-6 font-heading">
                            القيم التي <span className="text-red-600">تُحدد هويتنا</span>
                        </h2>
                        <div className="h-1 w-20 bg-green-600 mx-auto mb-8"></div>
                        <p className="text-gray-500 max-w-none mx-auto text-sm md:text-base leading-relaxed font-medium">
            ...
            <section className="py-20 bg-white dark:bg-slate-950 relative overflow-hidden">
                ...
                <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
                    ...
                    <div className="absolute top-1/2 right-0 w-[500px] h-[500px] bg-green-600/[0.03] rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2"></div>
                </div>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="relative group overflow-hidden">
                            ...
                            <div className="absolute -inset-1 bg-gradient-to-r from-red-600 via-green-600 to-red-600 opacity-20 group-hover:opacity-40 transition-opacity duration-700 blur-sm"></div>
                            ...
                            <div className="relative bg-[#0a0a0a] p-10 md:p-20 shadow-[0_40px_100px_-15px_rgba(0,0,0,0.6)] border border-white/5">
                                ...
                                <div className="absolute inset-0 opacity-10 pointer-events-none">
                                    <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_20%_30%,rgba(239,68,68,0.15),transparent_50%)]"></div>
                                    <div className="absolute bottom-0 right-0 w-full h-full bg-[radial-gradient(circle_at_80%_70%,rgba(34,197,94,0.1),transparent_50%)]"></div>
                                ...
                                <div className="relative z-20 flex flex-col lg:flex-row items-center gap-16">
                                    ...
                                    <div className="w-full lg:w-[60%] text-center lg:text-right">
                                        <div className="inline-flex items-center gap-3 px-6 py-2 bg-red-600/10 border border-red-500/20 mb-10 backdrop-blur-xl">
                                            <Sparkles className="w-4 h-4 text-red-500 animate-pulse" />
                                            <span className="text-xs font-black uppercase tracking-[0.4em] text-red-50">انضم إلى عائلتنا</span>
                                        </div>
                                        ...
                                        <h2 className="text-xl md:text-3xl lg:text-4xl font-black mb-6 font-heading text-white leading-[1.3] md:leading-[1.3]">
                                            ...
                                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-200">جزءاً من حكايتنا؟</span>
                                        </h2>
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
                                            <Link
                                                ...
                                                className="px-10 py-4 bg-red-600 hover:bg-red-700 text-white font-black text-lg shadow-[0_20px_40px_rgba(239,68,68,0.3)] transition-all duration-500 hover:-translate-y-1 flex items-center justify-center gap-4 group"
                                            >
                                    ...
                                    <div className="w-full lg:w-[40%] relative">
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="relative p-10 bg-white/[0.03] border border-white/10 backdrop-blur-2xl flex flex-col items-center justify-center text-center transform hover:-translate-y-3 hover:rotate-2 transition-all duration-700 group/card overflow-hidden">
                                                ...
                                                <div className="absolute top-0 right-0 w-8 h-8 border-t-2 border-r-2 border-red-600 transition-all duration-500 group-hover/card:w-full group-hover/card:h-full group-hover/card:opacity-20"></div>
                                                
                                                <div className="relative z-10">
                                                    <div className="w-14 h-14 bg-red-600/20 text-red-500 mb-6 flex items-center justify-center group-hover/card:scale-110 group-hover/card:rotate-12 transition-transform duration-500">
                                                        <Users size={28} />
                                                    </div>
                                                    <span className="text-4xl font-black text-white mb-2 block tracking-tight">5k+</span>
                                                    <span className="text-[11px] text-red-500/80 font-black uppercase tracking-[0.2em]">طالب فعال</span>
                                                </div>
                                                
                                                {/* Artistic Glow */}
                                                <div className="absolute -bottom-10 -left-10 w-24 h-24 bg-red-600/10 rounded-full blur-2xl group-hover/card:bg-red-600/20 transition-all"></div>
                                            </div>
                                            ...
                                            <div className="relative p-10 bg-white/[0.03] border border-white/10 backdrop-blur-2xl flex flex-col items-center justify-center text-center translate-y-12 transform hover:translate-y-8 hover:-rotate-2 transition-all duration-700 group/card overflow-hidden">
                                                {/* Creative Corner Decor */}
                                                <div className="absolute top-0 right-0 w-8 h-8 border-t-2 border-r-2 border-green-500 transition-all duration-500 group-hover/card:w-full group-hover/card:h-full group-hover/card:opacity-20"></div>
