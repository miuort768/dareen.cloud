    ...
    return (
        <div className="border-t border-border dark:border-border pt-8 mt-0 flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
                ...
                <a href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(post.title + ' ' + url)}`} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-black dark:bg-card flex items-center justify-center hover:opacity-80 transition-all text-on-primary dark:text-on-primary" title="تويتر">
