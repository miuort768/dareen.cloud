    ...
    <div className="relative flex min-h-full flex-col bg-background font-sans text-main transition-colors duration-500 dark:bg-background">
      ...
      <main className="relative flex-grow overflow-x-clip pb-6 md:pb-10 md:pt-32">
        <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
          <div className="absolute start-[-10%] top-[-15%] h-[60%] w-[60%] rounded-full bg-gradient-to-br from-primary/5 to-primary/5 blur-[140px] dark:from-primary/[0.05] dark:to-primary/[0.05]" />
          <div className="to-primary/3 absolute bottom-[-10%] end-[-10%] h-[50%] w-[50%] rounded-full bg-gradient-to-tr from-info-soft blur-[120px] dark:from-primary/[0.03] dark:to-primary/[0.03]" />
          <div className="absolute start-1/2 top-[40%] h-px w-[80%] -translate-x-1/2 bg-gradient-to-r from-transparent via-primary/10 to-transparent dark:via-primary/20" />
        </div>
