...
export const Courses = () => {
  ...
  const whatsappNumber = getNumber(' Ê«’· ⁄»— Ê« ”«»');
  ...
  return (
    <div className="min-h-full bg-background dark:bg-background font-sans text-main relative flex flex-col transition-colors duration-500">
      <SEO title="«·œÊ—«  «· ⁄·Ì„Ì… √Ê‰·«Ì‰" description="œÊ—«   ⁄·Ì„Ì… √Ê‰·«Ì‰ ··„‰«ÂÃ «·”⁄ÊœÌ… Ê«·ﬂÊÌ Ì… Ê«·≈„«—« Ì… Ê«·ﬁÿ—Ì… Ê«·⁄„«‰Ì… Ê«·»Õ—Ì‰Ì…. œ—Ê” Œ’Ê’Ì… ›Ì «·—Ì«÷Ì«  Ê«·⁄·Ê„ Ê«··€… «·⁄—»Ì… Ê«·≈‰Ã·Ì“Ì… Êﬁœ—«  Ê Õ’Ì·Ì ›Ì «·—Ì«÷ ÊÃœ… Ê«·ﬂÊÌ  Êœ»Ì Ê«·œÊÕ… Ê«·—Ì«‰ Ê„”ﬁÿ Ê’·«·… Ê«·„‰«„… Ê«·„Õ—ﬁ.  √”Ì” √ÿ›«·°  Õ›ÌŸ ﬁ—¬‰° „—«Ã⁄«  ‰Â«∆Ì… „⁄ ‰Œ»… «·„⁄·„Ì‰ «·Œ»—«¡." url="https://dareen.cloud/courses" image="/dareen_books_portal_v3.png" breadcrumbs={[{ name: '«·—∆Ì”Ì…', item: '/' }, { name: '«·œÊ—« ', item: '/courses' }]} />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 max-w-7xl">
                        ...
                        <div className="text-center mb-4 md:mb-6">
                            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-primary-soft/60 dark:bg-primary/15 backdrop-blur-sm border border-primary dark:border-primary/30 rounded-full mb-2 md:mb-6">
                                ...
                                <span className="text-micro font-black text-primary dark:text-primary">«” ﬂ‘› „”Ì— ﬂ «· ⁄·Ì„Ì…</span>
                            </div>
                            ...
                            <p className="text-sm sm:text-base text-muted dark:text-muted max-w-2xl mx-auto leading-relaxed font-medium md:whitespace-nowrap">
                                »—«„Ã  ⁄·Ì„Ì… „’„„… »⁄‰«Ì… · ı‰«”» Ã„Ì⁄ «·„—«Õ· Ê«·„” ÊÌ«  ó »√”·Ê»  ›«⁄·Ì ÌÃ⁄· «· ⁄·¯„  Ã—»… „„ ⁄…
                            </p>
                        </div>
                        </AnimateOnScroll>
          ...
          {filteredCourses.length > 0 ? (
            ...
            >
              {filteredCourses.map((course) => (
                ...
                >
                    ...
                    <div className="mt-auto flex items-center justify-between py-3 border-t border-border dark:border-primary/15">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <span className="text-micro font-bold text-muted dark:text-dim">ÿ«·»</span>
                        </div>
                      </div>
                  ...
                  <a
                    href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent(`«·”·«„ ⁄·Ìﬂ„° √—€» ›Ì «·«” ›”«— ⁄‰ ${course.title}`)}`}
                    target="_blank"
                  ...
                  {course.seoKeywords && (
                    <div className="absolute opacity-0 pointer-events-none overflow-hidden h-0" aria-hidden="true">
                      <h2>«·ﬂ·„«  «·„› «ÕÌ… - {course.title}</h2>
                      <p>{course.seoKeywords.short}</p>
                      <h3>ﬂ·„«  „› «ÕÌ… ÿÊÌ·… - {course.title}</h3>
            ...
            >
              ...
              <h2 className="text-xl font-black text-main dark:text-main mb-1">·«  ÊÃœ ‰ «∆Ã</h2>
              <p className="text-sm text-muted dark:text-muted font-medium">Ã—¯» ﬂ·„«  »ÕÀ „Œ ·›… √Ê «Œ —  ’‰Ì›« ¬Œ—</p>
            </motion.div>
          )}
        </div>
      </main>
