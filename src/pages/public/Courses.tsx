...
export const Courses = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans text-gray-800 relative flex flex-col">
            ...
            <main className="flex-grow pt-56 pb-24 relative overflow-hidden">
                ...
                <div className="absolute bottom-1/3 left-0 w-80 h-80 bg-blue-600/5 rounded-full blur-[100px] -translate-x-1/2"></div>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    <div className="text-center mb-20">
                        ...
                        <h1 className="text-3xl md:text-5xl lg:text-6xl font-heading font-black text-gray-900 mb-8">
                            <span className="block mb-6 md:mb-10">دورات معهد دارين</span>
