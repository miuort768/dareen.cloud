...
export const BlogPostHeader = ({ post }: BlogPostHeaderProps) => (
    <header className="container mx-auto px-4 max-w-4xl mb-6 md:mb-12">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-3 md:gap-0 mb-3 md:mb-6">
            ...
            <Link to="/books" className="order-1 md:order-2 w-full md:w-auto inline-flex items-center justify-center md:justify-start gap-2 px-4 py-2.5 bg-hover dark:bg-card text-main dark:text-main hover:bg-primary hover:text-on-primary dark:hover:text-on-primary transition-all font-black text-xs rounded-xl">
