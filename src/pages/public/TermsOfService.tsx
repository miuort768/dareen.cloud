    ...
    return (
        <div className="min-h-full bg-card dark:bg-background font-sans text-main dark:text-main">
            ...
            <section className="relative pt-24 pb-6 md:pt-36 md:pb-24 overflow-hidden bg-card">
                <div className="absolute top-0 end-0 w-96 h-96 bg-success/5 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2"></div>
                <div className="absolute bottom-0 start-0 w-64 h-64 bg-warning/5 rounded-full blur-[80px] translate-y-1/2 -translate-x-1/2"></div>
            ...
            <section className="py-8 md:py-20 bg-white">
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <div className="flex flex-col items-center justify-center py-6 px-6 bg-gradient-to-br from-[var(--bg-background)] to-white border border-border mb-8 relative overflow-hidden group rounded-card">
                        <div className="absolute top-0 end-0 w-32 h-32 bg-success/5 rounded-full -ms-16 -mt-16 blur-3xl"></div>
                        <div className="absolute bottom-0 start-0 w-32 h-32 bg-warning/5 rounded-full -me-16 -mb-16 blur-3xl"></div>
