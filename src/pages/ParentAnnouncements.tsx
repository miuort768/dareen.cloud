        ...
        <div className="min-h-full pb-32 px-2 lg:px-8 pt-6 space-y-6" dir="rtl">
            ...
            <div className="space-y-3">
                <div className="relative">
                    <Search className="absolute end-4 top-1/2 -translate-y-1/2 text-dim" size={18} />
                    <input
                        type="text"
                        placeholder="«»ÕÀ ›Ì «·√—‘Ì›..."
                        value={searchQuery}
                        onChange={(e) => setSearchQuery(e.target.value)}
                        className="w-full pe-12 ps-6 py-3.5 bg-white dark:bg-primary-active border border-border/50 dark:border-border/50 rounded-xl shadow-sm text-sm font-bold focus:outline-none focus:border-primary transition-all placeholder:text-muted dark:text-on-primary"
                    />
                </div>
