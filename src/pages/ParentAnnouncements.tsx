      ...
      <div className="space-y-3">
        <div className="relative">
          ...
          <input
            ...
            className="h-11 w-full rounded-xl border border-border bg-card pe-3 ps-10 text-xs font-bold text-main shadow-elevation-1 transition-colors placeholder:text-muted focus-visible:border-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/10 md:h-12 md:text-sm"
          />
        </div>
