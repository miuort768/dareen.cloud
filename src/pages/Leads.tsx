                ...
                <div className="bg-white/80 dark:bg-primary-active/80 backdrop-blur-xl rounded-2xl shadow-sm border border-border dark:border-border mb-6 p-4">
                    <div className="flex flex-col md:flex-row gap-3">
                        <div className="relative flex-1">
                            <Search className="absolute end-3 top-1/2 -translate-y-1/2 text-muted" size={14} />
                        ...
                        <div className="flex items-center gap-2 w-full md:w-auto">
                            ...
                            <div className="relative w-full md:w-auto">
                                ...
                                <ChevronDown className="absolute end-2 top-1/2 -translate-y-1/2 pointer-events-none text-muted" size={12} />
                            </div>
                        </div>
                    </div>
                </div>
