                ...
                <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <h1 className="text-lg md:text-2xl font-medium tracking-tight leading-none">إدارة المواعيد والجلسات</h1>
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        ...
                        <div className="bg-white/15 border border-white/20 px-3 py-1.5 text-center">
                            <p className="text-[8px] opacity-60 font-medium uppercase">متبقي</p>
                            <p className="text-xl font-medium tabular-nums leading-none text-emerald-300">{remainingToday}</p>
                        </div>
                        <div className="bg-white/15 border border-white/20 px-3 py-1.5 text-center">
                            <p className="text-[8px] opacity-60 font-medium uppercase">إجمالي</p>
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                <div className="flex items-center justify-between px-4 py-2.5 border-b border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-950">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-medium text-slate-600 dark:text-slate-300 uppercase tracking-widest">فلترة النتائج</span>
                        {hasActiveFilters && (
                            <span className="bg-indigo-100 text-indigo-700 text-[7px] font-medium px-1.5 py-0.5 uppercase">فلتر نشط</span>
                        )}
                    </div>
                    {hasActiveFilters && (
                        <button
                            ...
                            <div className="p-3 flex-1 flex flex-col justify-start min-h-[140px]">
                                {appointments.length > 0 ? (() => {
                                    ...
                                    <div className="flex-1 flex flex-col items-center justify-center py-6 opacity-30">
                                        ...
                                        <p className="text-[9px] font-medium uppercase tracking-widest">لا يوجد جلسات</p>
                                    </div>
                                )}
                            </div>
                        </motion.div>
