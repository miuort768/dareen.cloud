            ...
            <div className="px-4 grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                {filteredTasks.length > 0 ? (
                    ...
                    <div className="col-span-full py-20 text-center bg-white dark:bg-slate-900 border-2 border-dashed border-slate-100 dark:border-slate-800">
                        ...
                        <h2 className="text-xl font-medium text-slate-800 dark:text-white uppercase tracking-tighter mb-2">قائمة المهام</h2>
                        <p className="text-[10px] text-slate-400 font-normal uppercase tracking-widest">لم يتم العثور على مهام تطابق معايير البحث</p>
                    </div>
                )}
            </div>
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-none border-t-8 border-indigo-600 w-full max-w-xl shadow-[20px_20px_0px_rgba(79,70,229,0.1)] overflow-hidden">
                        <div className="p-8 border-b border-slate-50 dark:border-slate-800 flex justify-between items-center bg-slate-50/50 dark:bg-slate-800/30">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-medium text-slate-800 dark:text-white uppercase tracking-tighter">إنشاء مهمة جديدة</h3>
                            ...
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    <label className="text-[10px] font-medium text-slate-500 uppercase tracking-widest flex items-center gap-2">
                                        <Sparkles size={12} className="text-indigo-500" /> عنوان المهمة
                                    </label>
                                    <input 
                                        required
                                        type="text" 
                                ...
                                <div className="grid grid-cols-2 gap-8">
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-medium text-slate-500 uppercase tracking-widest">درجة الأولوية</label>
                                        <select 
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-medium text-slate-500 uppercase tracking-widest">تاريخ التسليم</label>
                                        <input 
                                            type="date" 
                                ...
                                <div className="space-y-2">
                                    <label className="text-[10px] font-medium text-slate-500 uppercase tracking-widest flex items-center gap-2">
                                        <ShieldCheck size={12} className="text-indigo-500" /> وصف المهمة
                                    </label>
                                    <textarea 
