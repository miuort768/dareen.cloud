            ...
            <div className="flex flex-col items-center gap-3 lg:flex-row">
              <div className="relative w-full flex-1">
                ...
                <input
                  ...
                  className="w-full rounded-card border border-border bg-card px-4 py-3 ps-10 text-xs font-bold text-main shadow-sm transition-all placeholder:text-muted focus-visible:border-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus"
                />
              </div>
              ...
              <div className="no-scrollbar flex w-full shrink-0 gap-1.5 overflow-x-auto md:w-auto">
                {(['all', 'high', 'medium', 'low'] as const).map((key) => (
                  <button
                    ...
                    className={cn(
                      'whitespace-nowrap rounded-xl border px-3 py-2 text-micro font-bold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus',
                      filterPriority === key
                        ? key !== 'all'
                ...
                {stats.completed > 0 && (
                  <button
                    ...
                    className="ms-auto flex shrink-0 items-center gap-1 whitespace-nowrap rounded-xl px-3 py-2 text-micro font-bold text-error transition-colors hover:bg-error-soft focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus disabled:opacity-50"
                  >
