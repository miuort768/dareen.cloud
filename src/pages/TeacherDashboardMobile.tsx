            ...
            <div className="px-3 pt-3 space-y-3.5">
                {activeTab === 'home' && (
                    <div role="tabpanel" id="tabpanel-home" aria-labelledby="tab-home">
                        ...
                        <section><div className="flex items-center gap-2 mb-2 px-1"><div className="w-1 h-4 bg-primary rounded-full" /><h2 className="text-main dark:text-on-primary text-sm font-black">البث المباشر</h2></div><div className="bg-card rounded-card shadow-sm overflow-hidden"><div className="p-3.5"><LiveClasses /></div></div></section>
                        <section><div className="flex items-center gap-2 mb-2 px-1"><div className="w-1 h-4 bg-warning rounded-full" /><h2 className="text-main dark:text-on-primary text-sm font-black">الإعلانات</h2></div><div className="bg-card rounded-card shadow-sm overflow-hidden"><div className="p-3.5"><ModernAnnouncements /></div></div></section>
                    </div>
                )}
                {activeTab === 'schedule' && (
                    <div role="tabpanel" id="tabpanel-schedule" aria-labelledby="tab-schedule">
                        {timeline.length > 0 ? (
                            <section><div className="flex items-center gap-2 mb-2 px-1"><div className="w-1 h-4 bg-info rounded-full" /><h2 className="text-main dark:text-on-primary text-sm font-black">حصص اليوم</h2></div><div className="bg-card rounded-card shadow-sm overflow-hidden"><div className="p-3.5"><TeacherSessionTimeline sessions={timeline} onStudentClick={setBriefingStudent} onSessionStart={(id) => navigate(`/classroom/${id}`)} /></div></div></section>
                        ) : (
                ...
                {activeTab === 'reports' && (
                    <div role="tabpanel" id="tabpanel-reports" aria-labelledby="tab-reports">
                        ...
                        <section><div className="flex items-center gap-2 mb-2 px-1"><div className="w-1 h-4 bg-success rounded-full" /><h2 className="text-main dark:text-on-primary text-sm font-black">الإنجازات</h2></div><div className="bg-card rounded-card shadow-sm overflow-hidden"><div className="p-3.5"><TeacherAchievements stats={stats} lowBalanceStudents={lowBalanceStudents} isTeacher={true} /></div></div></section>
                        <section><div className="flex items-center gap-2 mb-2 px-1"><div className="w-1 h-4 bg-error rounded-full" /><h2 className="text-main dark:text-on-primary text-sm font-black">المهام والطلبات</h2></div><div className="bg-card rounded-card shadow-sm overflow-hidden"><div className="p-3.5"><TasksAndRequests tasks={tasks} /></div></div></section>
                        <section><div className="flex items-center gap-2 mb-2 px-1"><div className="w-1 h-4 bg-warning rounded-full" /><h2 className="text-main dark:text-on-primary text-sm font-black">أعلى حضور</h2></div><div className="bg-card rounded-card shadow-sm overflow-hidden"><div className="p-3.5"><TopAttendanceStudents sessions={rawSessions} onStudentClick={setBriefingStudent} /></div></div></section>
                    </div>
                )}
                <div className="h-4" />
            </div>
