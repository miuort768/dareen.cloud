...
const tabs = [
    { id: 'home', label: '«·—∆Ì”Ì…', icon: LayoutDashboard, path: '' },
    { id: 'schedule', label: '«·ÃœÊ·', icon: Calendar, path: '' },
    { id: 'reports', label: '«· ﬁ«—Ì—', icon: CheckSquare, path: '' },
];
        ...
        >
            ...
            >
                <div className="flex items-center gap-2 text-primary font-bold text-xs">
                    {isRefreshing ? (
                        <><Loader2 size={16} className="animate-spin" /><span>Ã«—Ì «· ÕœÌÀ...</span></>
                    ) : pullDistance > 40 ? (
                        <><RefreshCw size={16} className="animate-pulse" /><span>√›·  ·· ÕœÌÀ</span></>
                    ) : (
                        <span className="text-muted">«”Õ» ·· ÕœÌÀ</span>
                    )}
                </div>
            </motion.div>
                ...
                <div className="px-5 pt-5 pb-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-base font-bold text-main dark:text-main leading-tight">{(currentUser?.name || currentUser?.username || '«·„⁄·„').split(' ')[0]}</h1>
                    ...
                    <div className="flex items-center gap-2 mt-3">
                        <div className="flex-1 bg-primary-soft dark:bg-primary/10 rounded-xl py-2.5 px-3 flex items-center gap-2 border border-primary/20 dark:border-primary/20">
                            ...
                            <div className="flex items-baseline gap-1"><span className="text-main dark:text-main font-bold text-base">{stats.todaySessions || 0}</span><span className="text-muted dark:text-muted text-[11px] font-medium">Õ’’</span></div>
                        </div>
                        <div className="flex-1 bg-primary-soft dark:bg-primary/10 rounded-xl py-2.5 px-3 flex items-center gap-2 border border-primary/20 dark:border-primary/20">
                            <Users size={13} className="text-info dark:text-primary shrink-0" />
                            <div className="flex items-baseline gap-1"><span className="text-main dark:text-main font-bold text-base">{stats.studentsCount || 0}</span><span className="text-muted dark:text-muted text-[11px] font-medium">ÿ·«»</span></div>
                        </div>
                        <div className="flex-1 bg-primary-soft dark:bg-primary/10 rounded-xl py-2.5 px-3 flex items-center gap-2 border border-primary/20 dark:border-primary/20">
                            <Award size={13} className="text-success dark:text-primary shrink-0" />
                            <div className="flex items-baseline gap-1"><span className="text-main dark:text-main font-bold text-base">{(stats.attendanceRate || 0)}%</span><span className="text-muted dark:text-muted text-[11px] font-medium">Õ÷Ê—</span></div>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <GlassCard className="p-4">
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="text-xs font-bold text-main">”Ã· «·œ›⁄« </p>
                                            <p className="text-[10px] text-muted">⁄—÷ «·„œ›Ê⁄«  Ê«·„” Õﬁ« </p>
                                        </div>
                                ...
                                <section>
                                    <div className="flex items-center gap-2 mb-3 px-1">
                                        ...
                                        <h2 className="text-[13px] font-bold text-main">«·»À «·„»«‘—</h2>
                                    </div>
                                ...
                                <section>
                                    <div className="flex items-center gap-2 mb-3 px-1">
                                        ...
                                        <h2 className="text-[13px] font-bold text-main">«·≈⁄·«‰« </h2>
                                    </div>
                                ...
                                {timeline.length > 0 ? (
                                    <section>
                                        <div className="flex items-center gap-2 mb-3 px-1">
                                            ...
                                            <h2 className="text-[13px] font-bold text-main">Õ’’ «·ÌÊ„</h2>
                                        </div>
                                        <GlassCard className="p-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <section>
                                    <div className="flex items-center gap-2 mb-3 px-1">
                                        ...
                                        <h2 className="text-[13px] font-bold text-main">«·≈‰Ã«“« </h2>
                                    </div>
                                ...
                                <section>
                                    <div className="flex items-center gap-2 mb-3 px-1">
                                        ...
                                        <h2 className="text-[13px] font-bold text-main">«·„Â«„ Ê«·ÿ·»« </h2>
                                    </div>
                                ...
                                <section>
                                    <div className="flex items-center gap-2 mb-3 px-1">
                                        <Sparkles size={14} className="text-warning" />
                                        <h2 className="text-[13px] font-bold text-main">√⁄·Ï Õ÷Ê—</h2>
                                    </div>
