            ...
            <div className="rounded-xl border border-border bg-card p-3 shadow-elevation-1 md:rounded-2xl md:p-5">
              ...
              <div className="flex gap-2 md:grid md:grid-cols-3 md:gap-2.5">
                {FEATURES.map((f) => (
                  <div
                    key={f.label}
                    className="dark:bg-surface/80 flex flex-1 items-center gap-2 rounded-lg border border-border bg-surface px-2.5 py-2 transition-all hover:border-primary/20 md:flex-col md:items-center md:px-4 md:py-3"
                  >
          ...
          <div className="mb-2 animate-[fadeUp_0.8s_ease-out_0.4s_both]">
            {adminPhone ? (
              <a
                ...
                className="group inline-flex items-center gap-2 rounded-2xl bg-primary px-6 py-3 text-xs font-bold text-on-primary shadow-lg shadow-primary/20 transition-all duration-200 hover:bg-primary-hover hover:shadow-xl hover:shadow-primary/25 active:scale-[0.97] md:px-8 md:py-3.5 md:text-sm"
              >
                <MessageCircle
                  size={16}
