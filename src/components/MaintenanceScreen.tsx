    ...
    return (
        <div className="h-dvh w-full bg-gradient-to-br from-[#020617] via-[#0f172a] to-black flex flex-col items-center justify-center p-6 text-center relative overflow-hidden font-sans" dir="rtl">
            ...
            <div className="relative z-10 max-w-xl w-full">
                {/* Status Icon */}
                <div className="mb-10">
                    <div className="w-24 h-24 mx-auto bg-[#5c59f2]/20 rounded-none flex items-center justify-center border border-[#5c59f2]/30  shadow-sm">
                ...
                {/* Title Section */}
                <div className="mb-12">
                    <h1 className="text-2xl md:text-4xl font-medium text-white leading-tight tracking-tighter uppercase mb-8">
                        المنصة في وضع <br/> 
                        <span className="text-[#5c59f2] underline decoration-4 decoration-[#5c59f2]/20 underline-offset-4">الصيانة الدورية</span>
                    </h1>
                    <p className="text-slate-400 font-normal text-sm md:text-base leading-relaxed max-w-xs mx-auto">
                ...
                <div className="flex flex-col items-center gap-4 mb-16">
                    ...
                    <span className="text-[10px] font-medium text-[#5c59f2] uppercase tracking-[0.5em] animate-pulse">
                        العمل جاري الآن
                    </span>
                </div>
            </div>
            ...
            {adminPhone && (
                <div className="absolute bottom-12 left-6 right-6 flex flex-col items-center">
                    <a
                        ...
                        className="inline-flex items-center justify-center bg-white hover:bg-[#5c59f2] text-[#020617] hover:text-white px-14 py-5 rounded-full text-sm md:text-base font-medium uppercase tracking-widest shadow-sm transition-all transform hover:scale-[1.05] active:scale-95 border-2 border-white"
                    >
