...
export const SEO: React.FC<SEOProps> = ({
    ...
    const siteDescription = description || "أكاديمية دارين لتعليم والتدريب - المنصة الأولى المعتمدة للتعليم عن بعد في الكويت، قطر، السعودية، الإمارات، وسلطنة عمان. نوفر أفضل المدرسين الخصوصيين، تحفيظ قرآن، وتأسيس ومراجعات للمناهج الخليجية والإنترناشونال.";
    const siteKeywords = keywords || "تعليم عن بعد, معهد دارين, مدرس خصوصي الكويت, دروس خصوصية قطر, افضل منصة تعليمية السعودية, معلمين الامارات, دروس اونلاين سلطنة عمان, تحفيظ قرآن عن بعد, منهج كويتي, منهج سعودي, قدرات وتحصيلي, تأسيس لغة عربية, مراجعات نهائية, اكاديمية تعليمية";
                        ...
                        "mainEntity": [
                            {
                                ...
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "أكاديمية دارين هي المنصة الرائدة والأولى المتخصصة في تقديم الدروس الخصوصية الأون لاين والمتابعات الدراسية للمناهج الخليجية وتأسيس الطلاب وتحفيظ القرآن بأعلى معايير الجودة."
                                }
                            },
                            {
                                "@type": "Question",
