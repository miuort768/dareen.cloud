    ...
    <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 max-w-5xl mx-auto">
        ...
        <div className="hidden lg:flex w-full lg:w-[45%] justify-center animate-in fade-in slide-in-from-end-8 duration-700 delay-300">
            <div className="relative w-full max-w-[380px] flex items-center justify-center">
                <div className="absolute inset-0 bg-gradient-to-br from-[var(--bg-primary)]/20 to-[var(--bg-primary)]/20 rounded-[2rem] blur-3xl animate-pulse pointer-events-none"></div>
                <picture>
