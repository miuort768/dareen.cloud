        ...
        <div className="relative" ref={dropdownRef}>
            ...
            >
                ...
                {notificationsEnabled && unreadCount > 0 && (
                    <span className="absolute -top-0.5 -end-0.5 min-w-[20px] h-5 px-1 bg-error rounded-full text-on-primary text-micro font-bold flex items-center justify-center border-2 border-white dark:border-border shadow-lg">
                        {unreadCount}
                    </span>
                )}
            </button>
            ...
            {isOpen && (
                <div className="fixed md:absolute inset-x-2 md:inset-auto top-[70px] md:top-full md:start-0 md:mt-3 w-auto md:w-[400px] bg-white/95 dark:bg-primary-active/98  border-2 border-border dark:border-border rounded-none shadow-[0_20px_50px_rgba(0,0,0,0.30)] z-[10000] animate-in fade-in slide-in-from-top-2 duration-300">
                    <div className="absolute -top-[10px] start-4 md:start-8 w-4 h-4 bg-white dark:bg-primary-active border-t-2 border-s-2 border-border dark:border-border rotate-45 hidden md:block" />
