...
export const InstallPWA = () => {
    ...
    return (
        <div className={`fixed z-[500] animate-in slide-in-from-bottom-5 fade-in duration-500 ${
            ...
            <div className={`bg-[#064E3B] border border-white/10 shadow-2xl backdrop-blur-md flex items-center gap-4 p-4 rounded-3xl ${
                ...
                <div className="flex items-center gap-2 shrink-0">
                    <button
                        ...
                        className="px-4 py-2 bg-white text-[#064E3B] font-black uppercase text-[10px] rounded-xl hover:bg-gray-100 transition-all flex items-center gap-2 active:scale-95 shadow-lg"
                    >
