...
export const InstallPWA = () => {
                ...
                <div className="bg-white border-2 border-border shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] w-full max-w-sm animate-in slide-in-from-bottom-5 fade-in duration-300">
                    <div className="bg-warning border-b-2 border-border px-4 py-3 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="font-medium text-sm text-main uppercase tracking-tighter text-end">
                                ثبتي التطبيق
                            </h2>
                        </div>
                    ...
                    <div className="p-4 space-y-3 bg-white text-end">
                        {isIOS ? (
                            <>
    ...
    return (
        <div className={`fixed z-[500] animate-in slide-in-from-bottom-5 fade-in duration-500 ${
            isDesktop ? 'bottom-4 end-4' : 'bottom-4 start-3 end-3'
        }`}>
