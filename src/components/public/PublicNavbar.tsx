                ...
                <div className="flex justify-between items-center h-12 md:h-14">
                    ...
                    <Link to="/" className="flex items-center gap-3 ps-2 group">
                        ...
                        <div className={cn(
                            ...
                            <span className="md:hidden text-micro text-primary dark:text-on-primary font-bold mt-0.5 bg-primary-soft/80 dark:bg-primary/40 px-2 py-0.5 rounded-md italic">
                                أفضل مدرسة افتراضية
                            </span>
                        </div>
                    </Link>
                    ...
                    {/* Desktop Nav */}
                    <div className="hidden md:flex items-center gap-2 bg-primary-soft dark:bg-white/5 backdrop-blur-md px-2 py-1.5 rounded-full border border-primary dark:border-white/10 shadow-sm">
                        {navItems.map((item) => (
                            <Link
                                key={item.path}
                                to={item.path}
                                className={`px-6 py-2 rounded-full font-bold text-sm transition-all duration-500 ${isActive(item.path)
                                    ...
                                    : 'text-muted hover:bg-primary-soft hover:text-primary dark:text-white/70 dark:hover:bg-white/10 dark:hover:text-white'
                                    }`}
                            >
                                {item.name}
                            </Link>
                            ...
                            <div className="relative" ref={dropdownRef}>
                                ...
                                <div className={`absolute end-0 mt-4 w-56 bg-white dark:bg-card rounded-2xl shadow-xl border border-border dark:border-border overflow-hidden z-50 transition-all duration-300 ${isDropdownOpen ? 'opacity-100 visible translate-y-0' : 'opacity-0 invisible -translate-y-2'}`}>
                                    ...
                                    <button
                                        ...
                                        className="flex w-full items-center gap-2 text-start px-4 py-3 text-sm text-error hover:bg-error-light dark:hover:bg-error/30 transition-colors"
