    ...
    <>
      ...
      <header className="md:hidden flex items-center justify-between px-2 pt-3 pb-2">
        ...
        <div className="flex items-center gap-1">
          ...
          {menuOpen && (
            <div className="absolute top-12 start-0 bg-white dark:bg-primary rounded-2xl shadow-2xl border border-border dark:border-border overflow-hidden z-50 min-w-[180px]">
              {navItems.map((item) => (
