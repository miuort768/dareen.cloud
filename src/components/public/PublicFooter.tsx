                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 lg:gap-6 mb-10">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-gray-400 dark:text-gray-300 text-sm leading-relaxed border-r-2 border-indigo-600/30 pr-4">
                            منصة تعليم عن بعد رائدة في السعودية والكويت والإمارات وقطر وعمان والبحرين. نقدم دروساً خصوصية أونلاين في الرياضيات، العلوم، اللغة العربية، الإنجليزية، قدرات وتحصيلي، وتحفيظ القرآن للأطفال وفق المناهج السعودية والكويتية والخليجية.
                        </p>
                    </div>
