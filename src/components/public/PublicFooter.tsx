    ...
    return (
        <footer className="relative bg-surface dark:bg-card text-main overflow-hidden pt-8 pb-6 md:pt-10 md:pb-6 transition-colors duration-500 min-h-[300px] border-t border-border">
            <div className="absolute inset-0 pointer-events-none opacity-10">
                ...
                <div className="absolute top-10 start-10 w-20 h-20 border border-border/20 rotate-45"></div>
                <div className="absolute bottom-20 end-10 w-32 h-32 border border-border/20 -rotate-12"></div>
                <div className="absolute top-1/2 start-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full opacity-10" style={{ backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 10px, rgba(99,102,241,0.06) 10px, rgba(99,102,241,0.06) 20px)' }}></div>
            </div>
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 lg:gap-6 mb-10">
                    <div className="space-y-6">
                        ...
                        <p className="text-muted text-sm lg:text-xs leading-relaxed border-e-2 border-border pe-4">
