        ...
        <>
            ...
            <section className="hidden md:block py-4 bg-surface dark:bg-black relative overflow-hidden transition-colors duration-500">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-6xl mx-auto bg-gradient-to-br from-primary via-primary-hover to-primary dark:from-[#1a1a1a] dark:via-[#0d0d0f] dark:to-[#1a1a1a] shadow-2xl overflow-hidden border border-white/5 dark:border-primary/30 relative rounded-2xl">
                        ...
                        <div className="flex flex-col lg:flex-row items-stretch min-h-[400px]">
                            ...
                            <div className="w-full lg:w-[60%] p-6 md:p-12 lg:p-14 text-on-primary relative z-20 text-center lg:text-start flex flex-col justify-center">
                                ...
                                <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-black mb-3 font-heading leading-tight">
                                    ...
                                    <span className="text-on-primary dark:text-black bg-primary dark:bg-primary px-3 py-1 md:px-5 md:py-1 inline-block transform -rotate-1 shadow-lg text-shadow-none whitespace-nowrap">دارين</span>
                                    <span className="text-on-primary dark:text-main">للمذكرات التعليمية</span>
                                </h2>
                                <p className="text-on-primary dark:text-soft text-micro sm:text-xs md:text-sm lg:text-base leading-relaxed mb-4 max-w-2xl mx-auto lg:mx-0 font-medium">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                                    <Link to="/books" className="px-10 py-4 bg-primary dark:bg-primary hover:bg-primary-hover dark:hover:bg-[#f59e0b] text-on-primary dark:text-black rounded-xl font-black text-lg shadow-2xl shadow-primary/20 dark:shadow-[#D4AF37]/20 hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-3 group">
