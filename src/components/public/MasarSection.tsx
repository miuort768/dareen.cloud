        ...
        <>
                    ...
                    <div className="max-w-6xl mx-auto bg-gradient-to-br from-[var(--bg-primary)] via-[var(--bg-primary-hover)] to-[var(--bg-primary-active)] shadow-2xl overflow-hidden border border-white/5 relative rounded-2xl">
                        ...
                        <div className="flex flex-col lg:flex-row items-stretch min-h-[400px]">
                            ...
                            <div className="w-full lg:w-[60%] p-6 md:p-12 lg:p-14 text-on-primary relative z-20 text-center lg:text-right flex flex-col justify-center">
                                ...
                                <p className="text-dim text-[10px] sm:text-xs md:text-sm lg:text-base leading-relaxed mb-4 max-w-2xl mx-auto lg:mx-0 font-medium opacity-90">
            ...
            <section className="block md:hidden relative overflow-hidden bg-background dark:bg-background pt-3 pb-4">
                ...
                <div className="relative z-10 px-4">
                    ...
                    {/* Title Card */}
                    <div className="bg-white dark:bg-primary-active rounded-2xl shadow-sm border border-border/80 dark:border-border p-5 mb-5 flex items-center justify-between">
                        <div>
                            <h2 className="text-main dark:text-on-primary text-lg font-black">بوابة الكتب والملخصات</h2>
                            <p className="text-muted dark:text-muted text-[11px] font-medium mt-0.5">جميع المذكرات في مكان واحد</p>
                        </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="text-center bg-white dark:bg-primary-active rounded-2xl shadow-sm border border-border/80 dark:border-border p-4">
                            <div className="w-12 h-12 mx-auto mb-2.5 rounded-2xl bg-primary-soft dark:bg-primary-active/30 flex items-center justify-center">
