        ...
        <>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-6xl mx-auto bg-gradient-to-br from-primary via-primary-hover to-primary shadow-2xl overflow-hidden border border-white/5 relative rounded-2xl">
                        ...
                        <div className="flex flex-col lg:flex-row items-stretch min-h-[400px]">
                            <div className="w-full lg:w-[40%] relative shrink-0 overflow-hidden bg-white/[0.08] backdrop-blur-md flex items-center justify-center p-8 lg:p-4 border-b lg:border-b-0 lg:border-e border-white/10 group">
                                <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/20 to-transparent animate-shine-slow pointer-events-none z-30"></div>
            ...
            <section className="block md:hidden relative overflow-hidden bg-background pt-3 pb-4">
                ...
                <div className="relative z-10 px-4">
                    ...
                    {/* Title Card */}
                    <div className="bg-surface dark:bg-primary rounded-2xl shadow-sm border border-border/80 dark:border-border p-5 mb-5 flex items-center justify-between">
                        <div>
                    ...
                    <div className="bg-gradient-to-br from-primary via-primary-hover to-primary rounded-3xl p-6 shadow-lg shadow-primary/20 mb-5">
                        ...
                        <div className="flex items-center gap-4 mb-4">
                            <div className="relative">
                                ...
                                <div className="absolute -bottom-1 start-0 w-full h-0.5 bg-white/80 rounded-full shadow-sm"></div>
                            </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="text-center bg-surface dark:bg-primary rounded-2xl shadow-sm border border-border/80 dark:border-border p-4">
                            <div className="w-12 h-12 mx-auto mb-2.5 rounded-2xl bg-primary-soft dark:bg-white/10 flex items-center justify-center">
                                <Shield size={20} className="text-primary dark:text-on-primary" />
                            </div>
                            <span className="text-main dark:text-white text-xs font-bold leading-tight block">جودة مضمونة</span>
                        </div>
                        <div className="text-center bg-surface dark:bg-primary rounded-2xl shadow-sm border border-border/80 dark:border-border p-4">
                            <div className="w-12 h-12 mx-auto mb-2.5 rounded-2xl bg-success-light dark:bg-white/10 flex items-center justify-center">
                                <BadgeCheck size={20} className="text-success dark:text-on-primary" />
                            </div>
                            <span className="text-main dark:text-white text-xs font-bold leading-tight block">محتوى موثوق</span>
                        </div>
                        <div className="text-center bg-surface dark:bg-primary rounded-2xl shadow-sm border border-border/80 dark:border-border p-4">
                            <div className="w-12 h-12 mx-auto mb-2.5 rounded-2xl bg-warning-light dark:bg-white/10 flex items-center justify-center">
                                <Headphones size={20} className="text-warning dark:text-on-primary" />
                            </div>
