...
export const BottomNav = () => {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 start-0 end-0 z-[50] bg-card/90 backdrop-blur-2xl border-t border-border pb-[env(safe-area-inset-bottom)] shadow-2xl">
