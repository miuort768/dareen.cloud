    ...
    return (
        <div className="min-h-screen bg-gray-50 flex font-sans dark:bg-slate-950 dark:text-slate-100 transition-colors duration-300 relative" dir="rtl">
            ...
            <div className="flex-1 flex flex-col transition-all duration-300 w-full max-w-full">
                ...
                <main className={cn(
                    "flex-1 relative max-w-full w-full",
                    (isChatOnly || location.pathname.includes('/chat')) 
                        ? "p-0 h-[100dvh] overflow-hidden" 
                        : "overflow-x-hidden custom-scrollbar px-2 md:px-5 lg:px-8 pt-2 md:pt-4 pb-20 lg:pb-8 rounded-none md:rounded-t-[32px] lg:rounded-[40px] sm:bg-transparent bg-gray-50/50 dark:bg-slate-950/50 md:shadow-[0_-10px_30px_rgba(0,0,0,0.03)] z-10"
                )}>
