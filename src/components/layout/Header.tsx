        ...
        <header className={cn(
            ...
            <div className="flex items-center gap-3 flex-1 min-w-0 overflow-hidden">
                <Link to="/" className="shrink-0">
                    <div className="w-8 h-8 overflow-hidden rounded-lg transition-shadow duration-300">
            ...
            <div className="flex items-center gap-1 sm:gap-2 shrink-0">
                ...
                >
                    <div className="w-9 h-9 bg-gradient-to-br from-primary-light to-primary-soft flex items-center justify-center text-muted rounded-full shrink-0 border-2 border-success/30 dark:border-success/40 group-hover:scale-105 group-active:scale-95 transition-all overflow-hidden">
                        {currentUser?.avatar ? (
