                                ...
                                >
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 flex items-center justify-center bg-slate-950 text-white rounded-none font-medium text-sm relative overflow-hidden group-hover:scale-105 transition-transform">
                                        ...
                                        <div className="flex flex-col items-center gap-1.5">
                                            <div className="flex -space-x-2 space-x-reverse">
                                                {children.slice(0, 3).map((child, i) => (
                                                    <div key={i} className="w-7 h-7 bg-white dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 flex items-center justify-center text-[10px] font-medium text-indigo-500">
                                                        {child.name.charAt(0)}
                                                    </div>
                                                ))}
                                                {children.length > 3 && (
                                                    <div className="w-7 h-7 bg-indigo-600 border-2 border-white dark:border-slate-900 flex items-center justify-center text-[8px] font-medium text-white">
                                                        +{children.length - 3}
                                                    </div>
                                                )}
                                            </div>
                        ...
                        >
                            ...
                            <div className="flex items-start justify-between mb-4">
                                <div className="flex items-center gap-3">
                                    <div className="w-12 h-12 bg-slate-950 text-white rounded-none flex items-center justify-center font-medium text-base shadow-sm">
                                        {parent.name.charAt(0)}
                                    </div>
                                    <div>
                            ...
                            <div className="flex items-center justify-between mt-4 pt-4 border-t border-slate-100 dark:border-slate-800">
                                ...
                                <div className="flex items-center gap-1.5 px-3 py-1 bg-indigo-600 text-white text-[10px] font-medium rounded-none shadow-sm">
                                    <Users size={11} />
                                    {children.length}
                                </div>
                            </div>
