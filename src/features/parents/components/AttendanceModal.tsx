                    ...
                    {isSessionsLoading ? (
                        ...
                        <>
                            {enrollments.map((en, idx: number) => {
                                ...
                                return (
                                    <div key={idx} className="p-5 border border-border/50 bg-background rounded-xl relative overflow-hidden group hover:border-success/30 hover:shadow-soft transition-all">
