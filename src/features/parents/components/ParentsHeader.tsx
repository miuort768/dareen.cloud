...
export const ParentsHeader: React.FC<ParentsHeaderProps> = ({
    ...
    return (
        <div className="bg-primary px-4 md:px-7 py-4 md:py-5 flex flex-col md:flex-row md:items-center justify-between gap-4 no-print rounded-2xl mt-4">
            ...
            <div className="flex items-center gap-2">
                ...
                <button
                    ...
                    className={cn(
                        "flex items-center gap-2 h-9 md:h-10 px-2 md:px-5 text-micro font-bold transition-all active:scale-95 rounded-xl",
                        showAddForm 
