    ...
    return (
        <div className="relative overflow-hidden bg-slate-950 px-4 md:px-8 py-5 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/5 no-print">
            ...
            <div className="relative z-10 flex items-center gap-2">
                <div className="hidden sm:flex items-center gap-1 bg-white/5 p-1 rounded-xl border border-white/5 mr-2">
                    <button
                        onClick={onImport}
                        className="h-8 px-3 flex items-center gap-2 hover:bg-white/10 text-slate-300 text-[10px] font-medium rounded-xl transition-all uppercase tracking-widest"
                    >
                        <Download size={13} />
                        استيراد
                    </button>
                ...
                <button
                    ...
                    className={cn(
                        "flex items-center gap-2 h-10 px-5 text-white text-[10px] font-medium rounded-xl transition-all uppercase tracking-widest shadow-sm shadow-teal-500/15 border",
                        showAddForm 
                            ? "bg-rose-500 border-rose-400/50 hover:bg-rose-600 shadow-rose-500/20" 
                            : "bg-blue-600 border-blue-400/50 hover:bg-blue-700"
                    )}
                >
