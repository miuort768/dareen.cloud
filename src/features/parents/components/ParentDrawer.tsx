                            ...
                            <div className="min-w-0">
                                ...
                                <div className="flex items-center gap-1.5 mt-1.5">
                                    ...
                                    <span className={cn(
                                        ...
                                        children.length > 0 ? 'bg-success-soft/80 text-on-success' : 'bg-surface/80 text-muted'
                                    )}>
                                        <span className={cn("w-1 h-1 rounded-full", children.length > 0 ? 'bg-success' : 'bg-muted')} />
                                        {children.length > 0 ? 'نشط' : 'غير نشط'}
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        {tab === 'overview' && (
                            <>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    {[
                                        { icon: Users, value: children.length, label: 'الأبناء', color: 'text-primary bg-primary-soft' },
                                        { icon: BookOpen, value: details?.totalEnrollments || 0, label: 'الاشتراكات', color: 'text-info bg-info-soft' },
                                        { icon: Calendar, value: `${details?.completedSessions || 0}/${details?.totalSessions || 0}`, label: 'الحصص', color: 'text-success bg-success-soft' },
                                        { icon: TrendingUp, value: `${details?.completionRate || 0}%`, label: 'الإنجاز', color: 'text-warning bg-warning-soft' },
                                    ].map((item, i) => (
