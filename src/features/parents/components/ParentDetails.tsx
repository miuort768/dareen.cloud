...
export const ParentDetails: React.FC<ParentDetailsProps> = ({
    ...
    return (
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 flex flex-col rounded-none overflow-hidden shadow-sm animate-in slide-in-from-left-4 duration-500">
            ...
            <div className="relative p-6 bg-slate-950 border-b border-white/5">
                ...
                <div className="relative z-10 flex flex-col items-center">
                    <div className="w-20 h-20 bg-gradient-to-br from-indigo-600 to-purple-700 p-0.5 rounded-none shadow-sm mb-4">
                    ...
                    <div className="flex flex-col gap-2 mt-4 w-full max-w-[280px]">
                        <div dir="ltr" className="flex items-center justify-between px-4 py-2 bg-white/5 border border-white/10 text-[11px] font-medium text-slate-300 rounded-none group hover:bg-white/10 transition-colors">
                        ...
                        {parent.email && (
                            <div dir="ltr" className="flex items-center justify-between px-4 py-2 bg-white/5 border border-white/10 text-[10px] font-medium text-slate-400 rounded-none group hover:bg-white/10 transition-colors">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
                            ...
                            <span className="text-[10px] font-medium bg-slate-900 text-white px-3 py-1 rounded-none">
                                ...
                                <div key={child.id} className="p-5 bg-slate-50 dark:bg-slate-800/40 border border-slate-100 dark:border-slate-800 rounded-none group hover:bg-white dark:hover:bg-slate-800 transition-all border-l-4 border-l-indigo-600 shadow-sm">
                                    <div className="flex justify-between items-center mb-4">
                                        <div>
                                            ...
                                            <p className="text-[10px] font-medium text-indigo-500 uppercase tracking-widest mt-0.5">{child.grade}</p>
                                        </div>
                                ...
                                return Object.values(grouped).map((group, idx) => (
                                    <div key={idx} className="p-4 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-none shadow-sm hover:border-indigo-200 transition-colors">
                                        ...
                                        <div className="flex flex-wrap gap-2 pt-3 border-t border-slate-50 dark:border-slate-800">
                                            {group.times.map((t, i) => (
                                                <div key={i} className="flex items-center gap-3 px-3 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 text-[10px] font-medium rounded-none">
