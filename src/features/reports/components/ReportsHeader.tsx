        ...
        <div className="bg-card rounded-2xl shadow-sm border border-border px-4 md:px-6 py-5 flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-[11px] font-bold text-muted mt-0.5">{dateStr}</p>
                </div>
            </div>

            <div className="flex items-center gap-2 no-print">
                <div className="hidden md:flex items-center gap-1.5 text-[10px] font-bold px-3 py-1.5 rounded-xl bg-success-soft text-success-dark">
                    <div className="w-1.5 h-1.5 rounded-full animate-pulse bg-success" />
                    مزامنة نشطة
                </div>
                <button
                    onClick={onExport}
                    className="flex items-center justify-center gap-2 bg-primary text-on-primary text-[10px] font-bold px-4 py-2.5 rounded-xl shadow-sm active:scale-95 transition-all"
                >
                    <Download size={14} />
