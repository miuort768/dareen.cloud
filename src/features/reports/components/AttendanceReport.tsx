                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-right">
                        <thead className="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-gray-800 dark:to-gray-800 text-xs font-bold text-gray-700 dark:text-gray-300">
                            <tr>
                                <th className="px-6 py-4 text-center">اسم المعلمة</th>
                                <th className="px-6 py-4 text-center">الحصص المتوقعة</th>
                                <th className="px-6 py-4 text-center">الحصص المكتملة</th>
                                <th className="px-6 py-4 text-center">الحصص الملغية</th>
                                ...
                                <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                    <td className="px-6 py-2.5 text-center">
                                        <div className="flex items-center justify-center gap-3">
                                            <div className="w-8 h-8 rounded-full bg-purple-500/10 text-purple-700 flex items-center justify-center font-black text-xs border border-purple-500/20">{teacher.teacher.charAt(0)}</div>
                                            <p className="text-sm font-bold text-gray-900 dark:text-white">{teacher.teacher}</p>
                                        </div>
                                    </td>
                                    <td className="px-6 py-2.5 text-center font-mono text-sm font-bold">{teacher.total}</td>
                                    <td className="px-6 py-2.5 text-center font-mono text-sm font-bold text-emerald-600">{teacher.completed}</td>
                                    <td className="px-6 py-2.5 text-center font-mono text-sm font-bold text-rose-600">{teacher.cancelled}</td>
