  ...
  return (
    <section>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="rounded-card bg-card border shadow-card p-4">
        ...
        <div className="rounded-card bg-surface border shadow-card p-4">
        ...
        <div className="rounded-card bg-gradient-to-br from-accent to-accent-hover text-on-accent shadow-card p-4">
