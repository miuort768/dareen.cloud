                        ...
                        isMe ? "justify-start" : "justify-end"
                                ...
                                >
                                    <div className={cn(
                                        ...
                                        {isGroup && !isMe && (
                                            <span className="block text-xs font-normal text-primary mb-0.5 text-start">
                                                {msg.senderName}
                                            </span>
                                        )}

                                        <div className="text-sm text-main leading-[1.4] whitespace-pre-wrap text-start tracking-tight">
                                            {msg.content}
                                        </div>
