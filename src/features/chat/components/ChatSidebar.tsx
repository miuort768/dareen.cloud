...
export const ChatSidebar: React.FC<ChatSidebarProps> = ({
  ...
  return (
    ...
    >
      <div className="border-border/50 flex h-[60px] shrink-0 items-center justify-between border-b bg-surface px-4 dark:border-white/5 dark:bg-card">
        <div className="flex items-center gap-2">
          <div className="border-success/30 h-10 w-10 shrink-0 overflow-hidden rounded-full border-2 shadow-sm">
            <Image
          ...
          {currentUser?.role === 'admin' && (
            <>
              ...
              <button
                ...
                className="dark:hover:bg-error/20 relative flex cursor-pointer items-center justify-center rounded-full p-2 text-error transition-all hover:bg-error-light"
      ...
      <div className="border-b border-border bg-white p-2 dark:border-white/5 dark:bg-card">
        <div className="relative flex items-center rounded-lg border-0 bg-hover px-3 py-1.5 outline-none ring-0 transition-colors dark:bg-card">
          ...
          <input
            ...
            className="placeholder:text-muted/80 flex-1 border-0 bg-transparent px-4 py-1 text-start text-sm font-medium text-main ring-0 focus:outline-none focus:ring-0"
          />
        </div>
      </div>
      ...
      <div className="dark:bg-card/90 border-success/10 sticky bottom-0 z-[100] w-full border-t bg-white/80 p-3 text-center">
