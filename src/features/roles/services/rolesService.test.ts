...
describe('rolesService', () => {
    ...
    beforeEach(() => {
        server.use(
            http.get(baseUrl, () =>
                HttpResponse.json([
                    { id: 1, name: 'admin', label: 'مدير النظام', description: null, isSystem: 1, _count: { userRoles: 2 } },
                    { id: 2, name: 'manager', label: 'مدير', description: 'مدير تنفيذي', isSystem: 0, _count: { userRoles: 0 } },
                ]),
            ),
