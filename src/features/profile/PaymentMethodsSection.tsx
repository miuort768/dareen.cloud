...
const PaymentMethodForm = ({
  ...
  >
    ...
    >
      ...
      <form onSubmit={onSubmit} className="no-scrollbar flex-1 space-y-5 overflow-y-auto px-5 pb-4">
        {/* اختيار النوع */}
        <div>
            ...
            {METHODS.map((m) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-center text-micro font-bold leading-tight">{m.label}</span>
                </button>
              )
            })}
          </div>
