                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
                    ...
                    {enrollment?.nextSessionNotes && (
                        <div className="bg-warning-soft dark:bg-primary/5 p-5 border-2 border-warning dark:border-primary/30 rounded-none relative">
                             ...
                             <p className="text-micro font-medium text-warning dark:text-primary uppercase mb-2">تحضير الجلسة القادمة</p>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            {recentSessions.length > 0 ? recentSessions.map((sess, idx) => (
                                <div key={idx} className="p-4 bg-card dark:bg-card border-2 border-border/10 dark:border-primary/10 hover:border-border dark:hover:border-[#D4AF37]/30 transition-all rounded-none flex items-center justify-between group">
