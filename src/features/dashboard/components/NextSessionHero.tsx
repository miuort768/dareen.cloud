...
export const NextSessionHero = ({ timeline, onStart }: NextSessionHeroProps) => {
    ...
    return (
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary via-primary-deep to-primary-soft dark:from-primary dark:via-primary-deep dark:to-warning p-5">
            ...
            <div className="relative z-10">
                <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-white/70 dark:text-on-primary/70 text-micro font-bold">«·Õ’… «·ﬁ«œ„…</span>
                </div>
