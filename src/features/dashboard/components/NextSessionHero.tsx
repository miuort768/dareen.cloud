...
export const NextSessionHero = ({ timeline, onStart }: NextSessionHeroProps) => {
    ...
    return (
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary via-primary-deep to-primary-soft dark:from-[#D4AF37] dark:via-[#b8962e] dark:to-[#f59e0b] p-5">
            ...
            <div className="relative z-10">
                <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-white/70 dark:text-black/70 text-micro font-bold">الحصة القادمة</span>
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-white/70 dark:text-black/70 font-medium">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-white/15 dark:bg-black/20">
                            <Clock size={15} className="text-white/80 dark:text-black/70" />
                            <span className={cn(
                ...
                <div className="mt-4 flex items-center justify-between">
                    <span className="text-sm text-white/60 dark:text-black/60 font-medium">{nextSession.time}</span>
                    <Button
                        onClick={() => onStart(nextSession.id)}
                        className="bg-white/20 dark:bg-black/20 hover:bg-white/30 dark:hover:bg-black/30 text-white dark:text-black border-0 gap-2"
                        size="sm"
                    >
