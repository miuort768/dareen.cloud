...
export const MobileAdminDashboard = ({
    ...
    return (
        <div className="space-y-4 pb-24 animate-in fade-in duration-700 text-right" dir="rtl">
            ...
            <div className="flex justify-between items-center bg-gradient-to-r from-indigo-600 to-indigo-700 dark:from-indigo-905 dark:to-indigo-950 p-4 rounded-none shadow-lg border-b-4 border-indigo-800 transition-all">
                <div className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-white/20 backdrop-blur-md rounded-none flex items-center justify-center text-white border border-white/20 shadow-sm">
                        <ShieldCheck size={24} />
                    </div>
                    <div>
                ...
                {/* Clock Badge */}
                <div className="px-3 py-1.5 bg-white/10 border border-white/10 rounded-none text-white font-black text-[10px] tabular-nums">
            ...
            <div className="bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-none p-5 text-white shadow-xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <div className="flex justify-between items-start mb-4">
                        <div>
                            <span className="bg-white/20 text-white border border-white/20 text-[8px] font-black px-1.5 py-0.5 rounded-none uppercase tracking-widest">
                                النشاط الأكاديمي اليومي
                            </span>
                            <h3 className="text-sm font-black mt-2">معدل تنفيذ الحصص</h3>
                        </div>
                        <div className="w-10 h-10 bg-white/20 backdrop-blur-md rounded-none flex items-center justify-center shrink-0 border border-white/10">
                            <Award size={20} />
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="w-full h-2.5 bg-white/15 rounded-none overflow-hidden">
                            <div 
                                style={{ width: `${Math.min(completionRate, 100)}%` }}
                                className="h-full bg-white rounded-none shadow-[0_0_10px_rgba(255,255,255,0.5)] transition-all duration-700"
                            />
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-white dark:bg-slate-900 p-4 rounded-none shadow-sm border border-slate-100 dark:border-slate-800 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                    <div className="bg-emerald-50/50 dark:bg-emerald-950/10 p-3 rounded-none border border-emerald-100/30 dark:border-emerald-900/20">
                    ...
                    <div className="bg-rose-50/40 dark:bg-rose-950/10 p-3 rounded-none border border-rose-100/30 dark:border-rose-900/20">
                        <div className="flex items-center gap-2 mb-1">
            ...
            <div className="bg-[#5c4fb1] dark:bg-[#4a3f9e] p-5 rounded-none shadow-lg text-white flex flex-col items-center justify-between gap-6 relative overflow-hidden">
                <div className="absolute right-0 bottom-0 w-32 h-32 bg-white/5 rounded-none blur-2xl -translate-x-1/2 translate-y-1/2" />
                ...
                <button 
                    ...
                    className="bg-white text-[#5c4fb1] px-5 py-2.5 rounded-none font-black text-[9px] uppercase tracking-widest flex items-center justify-center gap-2.5 transition-transform active:scale-95 shadow-xl w-full"
                >
                    <Headphones size={12} />
...
const QuickStatCard = ({ icon: Icon, label, value, color }: any) => {
    ...
    return (
        <div className="bg-white dark:bg-slate-900 py-3 px-2 rounded-none shadow-sm border border-slate-50 dark:border-slate-800/80 flex flex-col items-center justify-center text-center">
            <div className={cn("w-8 h-8 rounded-none flex items-center justify-center mb-1.5", colors[color])}>
                <Icon size={14} />
            </div>
