...
export const MobileAdminDashboard = ({
    ...
    return (
        <div
            ...
            className="pb-4 text-end overflow-x-hidden relative bg-background dark:bg-background"
            dir="rtl"
        >
                        ...
                        {[
                            ...
                            >
                                ...
                                {tab.badge !== undefined && tab.badge > 0 && (
                                    <span className="absolute -top-1 -start-1 min-w-[16px] h-[16px] bg-gradient-to-br from-[var(--bg-success)] to-[var(--bg-success)] text-on-primary font-bold text-micro flex items-center justify-center px-1 border-2 border-white dark:border-border rounded-full shadow-sm">
                                        {tab.badge}
                                    </span>
                                )}
                            </motion.button>
                    ...
                    {activeTab === 'alerts' && (
                        ...
                        >
                            ...
                            <motion.div {...fadeUp} className="relative rounded-2xl p-5 shadow-sm overflow-hidden bg-gradient-to-br from-[var(--bg-primary)] to-[var(--bg-primary-hover)]">
                                ...
                                <div className="absolute -bottom-8 -start-8 w-24 h-24 bg-info-light/10 rounded-full blur-xl" />
