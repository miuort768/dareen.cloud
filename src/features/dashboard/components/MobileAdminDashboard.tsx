                        ...
                        {[
                            ...
                            >
                                ...
                                {tab.badge !== undefined && tab.badge > 0 && (
                                    <span className="absolute -top-1 -end-1 min-w-[16px] h-[16px] bg-success text-on-success font-bold text-micro flex items-center justify-center px-1 border-2 border-white dark:border-border border-border rounded-full shadow-soft">
                                        {tab.badge}
                                    </span>
                                )}
                            </button>
