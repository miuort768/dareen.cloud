        ...
        >
            ...
            <div className={cn("p-5", isLarge ? "md:p-6" : "md:p-5")}>
                ...
                <div className="space-y-0.5">
                    <p className={cn("font-bold tabular-nums text-main dark:text-main tracking-tight", isLarge ? "text-3xl" : "text-2xl")}>
                    ...
                    <p className="text-xs text-muted dark:text-muted font-medium">{item.title}</p>
                </div>
            </div>
        </motion.div>
    );
