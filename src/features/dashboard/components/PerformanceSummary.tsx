                ...
                {isTeacher ? (
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div className="p-6 bg-primary/5 border border-primary/10 rounded-[2rem] relative overflow-hidden group">
                            <div className="absolute top-0 end-0 w-24 h-24 bg-primary opacity-5 blur-2xl group-hover:opacity-20 transition-opacity"></div>
                        ...
                        <div className="p-6 bg-error/5 border border-error/10 rounded-[2rem] relative overflow-hidden group">
                            <div className="absolute top-0 end-0 w-24 h-24 bg-error opacity-5 blur-2xl group-hover:opacity-20 transition-opacity"></div>
