...
export const PerformanceSummary = ({ stats, isTeacher }: PerformanceSummaryProps) => {
    return (
        <div className="bg-white dark:bg-slate-900 border-2 border-gray-950 dark:border-slate-800 shadow-[4px_4px_0px_0px_black] rounded-none relative overflow-hidden group h-full">
            ...
            <div className="p-3 border-b-2 border-gray-950 dark:border-slate-800 flex items-center justify-between bg-emerald-600">
                <div className="flex items-center gap-3">
                    <div className="p-2 bg-white text-gray-950 rounded-none border-2 border-gray-950">
                        <TrendingUp size={16} />
                    </div>
                    <div>
                        <h3 className="font-black text-white text-xs uppercase tracking-tighter italic leading-none">ملخص الأداء</h3>
                ...
                {isTeacher ? (
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-3">
                            <div className="p-3 bg-primary-50 dark:bg-primary-900/10 border-2 border-gray-950 rounded-none shadow-[2px_2px_0px_0px_black]">
                                ...
                                <h4 className="text-base font-black text-gray-950 dark:text-white">{stats.studentsCount}</h4>
                            </div>
                            <div className="p-3 bg-emerald-50 dark:bg-emerald-900/10 border-2 border-gray-950 rounded-none shadow-[2px_2px_0px_0px_black]">
                                ...
                                <h4 className="text-base font-black text-gray-950 dark:text-white">{stats.completedSessions}</h4>
                            </div>
                        </div>
                    </div>
                ) : (
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div className="p-3 bg-indigo-50 dark:bg-indigo-900/10 border-2 border-gray-950 rounded-none relative overflow-hidden shadow-[2px_2px_0px_0px_black]">
                            <p className="text-[10px] font-black text-indigo-600 uppercase mb-1">مدفوع</p>
                            <h4 className="text-lg font-black text-gray-950 dark:text-white tabular-nums">{stats.paidInvoices}</h4>
                        </div>
                        <div className="p-3 bg-rose-50 dark:bg-rose-900/10 border-2 border-gray-950 rounded-none relative overflow-hidden shadow-[2px_2px_0px_0px_black]">
                            <p className="text-[10px] font-black text-rose-600 uppercase mb-1">معلق</p>
                            <h4 className="text-lg font-black text-gray-950 dark:text-white tabular-nums">{stats.pendingInvoices}</h4>
                        </div>
                    </div>
                )}
            </div>
