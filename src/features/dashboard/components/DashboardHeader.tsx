...
export const DashboardHeader = ({ isTeacher, currentUser }: DashboardHeaderProps) => {
    ...
    return (
        <div className={cn(
            "relative overflow-hidden bg-slate-950 px-6 md:px-8 py-6 flex flex-col md:flex-row md:items-center justify-between gap-6 border border-white/10 rounded-none mb-6 shadow-2xl shadow-indigo-500/5"
        )} dir="rtl">
            ...
            <div className="relative z-10 flex items-center gap-5 w-full md:w-auto">
                <div className="w-12 h-12 flex items-center justify-center bg-white/5 border border-white/10 rounded-none transition-all hover:bg-white/10">
            ...
            <div className="relative z-10 flex flex-wrap items-center justify-center md:justify-end gap-3 w-full md:w-auto">
                ...
                <button
                    ...
                    className="h-10 px-6 font-black text-[10px] uppercase tracking-widest flex items-center gap-2 transition-all active:scale-[0.98] bg-amber-500 hover:bg-amber-600 text-white border border-amber-400/50 rounded-none shadow-lg shadow-amber-500/10"
                >
                    <Headphones size={14} />
