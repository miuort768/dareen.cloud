...
export const DashboardHeader = ({ isTeacher, currentUser }: DashboardHeaderProps) => {
    ...
    return (
        <div className={cn(
            "relative overflow-hidden bg-slate-950 px-6 md:px-8 py-6 flex flex-col md:flex-row md:items-center justify-between gap-6 border border-white/10 rounded-3xl mb-6 shadow-2xl shadow-indigo-500/5"
        )} dir="rtl">
            ...
            <div className="relative z-10 flex items-center gap-5 w-full md:w-auto">
                <div className="w-14 h-14 flex items-center justify-center bg-white/5 border border-white/10 rounded-2xl transition-all hover:bg-white/10">
                    <img src="/logo.png" alt="Logo" className="w-10 h-10 object-contain" />
                </div>
                
                <div className="text-right">
                    <div className="flex items-center gap-2 mb-1.5">
                        <div className="bg-white/10 text-white border border-white/10 text-[9px] font-black px-2 py-0.5 uppercase tracking-widest leading-none flex items-center gap-1.5 rounded-full">
            ...
            <div className="relative z-10 flex flex-wrap items-center justify-center md:justify-end gap-3 w-full md:w-auto">
                {/* Time Widget */}
                <div className="flex items-center gap-2.5 px-4 h-10 border border-white/10 bg-white/5 hover:bg-white/10 transition-all text-white rounded-2xl">
                ...
                <button
                    ...
                    className="h-10 px-6 font-black text-[10px] uppercase tracking-widest flex items-center gap-2 transition-all active:scale-[0.98] bg-amber-500 hover:bg-amber-600 text-white border border-amber-400/50 rounded-2xl shadow-lg shadow-amber-500/10"
                >
                    <Headphones size={14} />
