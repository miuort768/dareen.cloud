...
export const TeacherWeeklySummary = ({ stats }: TeacherWeeklySummaryProps) => {
    return (
        <div className="bg-primary-600 border-4 border-gray-950 p-6 flex flex-col justify-between h-full shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] text-white relative overflow-hidden group">
