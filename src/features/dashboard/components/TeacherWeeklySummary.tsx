...
export const TeacherWeeklySummary = ({ stats }: TeacherWeeklySummaryProps) => {
    return (
        <div className="bg-primary border-4 border-border p-6 flex flex-col justify-between h-full shadow-[8px_8px_0px_0px_black] text-on-primary relative overflow-hidden group">
            
            {/* Background pattern */}
            <div className="absolute top-0 start-0 w-32 h-32 bg-white/10 -translate-x-1/2 -translate-y-1/2 rotate-45 pointer-events-none group-hover:bg-white/20 transition-all"></div>
            ...
            <div className="relative z-10">
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between p-3 bg-white text-main border-2 border-border shadow-[4px_4px_0px_0px_rgb(0_0_0_/_0.5)]">
