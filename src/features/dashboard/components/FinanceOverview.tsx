    ...
    return (
            ...
            {payload.map((entry, i) => (
                <div key={i} className="flex items-center justify-between gap-4 py-0.5">
                    ...
                    <span className="text-xs font-bold text-main dark:text-main tabular-nums">
        ...
        <div className="rounded-2xl bg-card dark:bg-card border border-border dark:border-border shadow-sm p-5" dir="rtl">
            ...
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-primary-soft dark:bg-primary/10 flex items-center justify-center">
            ...
            {monthlyData.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-10 text-center">
                    ...
                    <p className="text-[11px] text-dim dark:text-dim mt-1">ابدأ بإضافة أول عملية مالية</p>
