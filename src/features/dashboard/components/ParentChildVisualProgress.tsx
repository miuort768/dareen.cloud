    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {childrenProfiles.map((child) => {
                ...
                return (
                    <div key={child.id} className="bg-white border-4 border-border p-6 dark:bg-card dark:border-border shadow-[8px_8px_0px_0px_black] relative group">
                        ...
                        <div className="pt-6 border-t-2 border-border dark:border-border flex items-center justify-between">
                            ...
                            <a 
                                ...
                                className="px-5 py-2.5 bg-success text-main border-2 border-border font-medium text-micro uppercase tracking-widest shadow-[4px_4px_0px_0px_black] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all flex items-center gap-2 group/btn"
                            >
