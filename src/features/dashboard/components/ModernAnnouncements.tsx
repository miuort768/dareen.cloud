    ...
    return (
        <div className="relative bg-white dark:bg-primary-active border border-border dark:border-border overflow-hidden transition-all duration-300 h-full rounded-2xl" dir="rtl">
            <div className="flex flex-col md:flex-row items-stretch">
                ...
                >
                    <div className="absolute top-4 start-6 flex items-center gap-1.5 px-2 py-0.5 bg-background text-on-primary dark:bg-white dark:text-main rounded-lg">
                    ...
                    {announcements.length > 1 && (
                        <div className="absolute bottom-4 start-6 flex gap-2" onClick={e => e.stopPropagation()}>
            ...
            {/* Progress Bar */}
            <div className="absolute bottom-0 end-0 h-1 bg-surface dark:bg-primary-active w-full" />
            <motion.div 
                className="absolute bottom-0 end-0 h-1 bg-info"
                initial={{ width: "0%" }}
