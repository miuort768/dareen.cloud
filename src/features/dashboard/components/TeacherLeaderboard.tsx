...
export const TeacherLeaderboard = ({ students, onStudentClick }: TeacherLeaderboardProps) => {
    ...
    return (
        <div className="bg-white border-4 border-border p-6 dark:bg-card dark:border-border shadow-[8px_8px_0px_0px_#000] relative overflow-hidden group h-full flex flex-col">
