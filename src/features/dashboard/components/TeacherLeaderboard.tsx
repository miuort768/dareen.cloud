        ...
        <div className="bg-white border-4 border-gray-950 p-6 dark:bg-gray-900 dark:border-gray-800 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden group h-full flex flex-col">
                    ...
                    return (
                        ...
                        >
                            <div className="flex items-center gap-3">
                                <div className={cn("w-8 h-8 flex items-center justify-center font-medium text-xs border-2 border-gray-950 shadow-[2px_2px_0px_0px_black]",
                                ...
                                <div>
                                    <div className="flex items-center gap-2">
                                        <h4 className="text-xs font-medium text-gray-900 dark:text-white uppercase tracking-tighter">
                                            {student.name}
                                        </h4>
                                        {index < 3 && (
                                            <div className="flex items-center gap-1 bg-yellow-400 text-gray-950 px-1.5 py-0.5 text-[8px] font-medium border border-gray-950 shadow-[1px_1px_0px_0px_black] animate-pulse">
                                    ...
                                    <div className="flex items-center gap-1.5 mt-0.5">
                                        ...
                                        <p className="text-[9px] font-medium text-gray-400 uppercase tracking-widest leading-none">{student.grade}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-2">
                                <div className="flex flex-col items-end">
                                    ...
                                    <span className="text-[8px] font-medium text-gray-400 uppercase leading-none">نقطة</span>
                                </div>
                            </div>
                        </div>
                    );
            ...
            <div className="mt-6 pt-6 border-t-2 border-gray-100 dark:border-gray-800 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-medium text-gray-400">نشاط المجموعة مرتفع هذا الأسبوع</span>
                </div>
            </div>
        </div>
    );
