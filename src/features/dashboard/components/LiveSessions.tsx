        ...
        <div className="rounded-2xl bg-card dark:bg-[#0d0d0f] border border-border dark:border-[#D4AF37]/20 p-5 font-dash" dir="rtl">
            ...
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-success-soft dark:bg-success/10 flex items-center justify-center">
                        ...
                        >
                            <div className="flex items-center gap-3 min-w-0">
                                <div className="relative shrink-0">
                                    <div className="w-10 h-10 rounded-xl bg-success-soft dark:bg-success/10 flex items-center justify-center">
