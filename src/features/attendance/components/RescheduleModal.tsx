    ...
    return (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
            <div className="bg-white dark:bg-slate-900 w-full max-w-md rounded-2xl shadow-sm border border-slate-100/50 dark:border-slate-800/50 overflow-hidden flex flex-col">
                ...
                <div className="p-4 bg-gradient-to-l from-[#6C4BFF] to-[#8B5CF6] text-white flex items-center justify-between">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <input
                                    ...
                                    className="w-full text-xs font-bold p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl outline-none focus:border-[#6C4BFF] transition-all"
                                />
                                <input
                                    type="text"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full text-xs font-bold p-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl outline-none focus:border-[#6C4BFF] transition-all min-h-[100px] resize-none"
                            />
                        </div>
                ...
                <div className="p-5 pt-0 flex gap-3">
                    ...
                    <button
                        ...
                        className="flex-[2] py-3 bg-gradient-to-l from-[#6C4BFF] to-[#8B5CF6] text-white border-0 font-bold text-xs rounded-xl shadow-sm hover:from-[#5a3ee0] hover:to-[#7c3aed] transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    >
                        <Save size={16} />
                        إرسال الطلب الآن
                    </button>
