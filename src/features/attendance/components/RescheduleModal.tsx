...
export const RescheduleModal = ({ isOpen, onClose, onConfirm, studentName, subject }: RescheduleModalProps) => {
    ...
    return (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-gray-950/40 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white dark:bg-gray-900 border-4 border-gray-950 w-full max-w-md rounded-2xl shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] overflow-hidden flex flex-col">
                ...
                <div className="p-6 space-y-6">
                    <div className="bg-gray-50 dark:bg-gray-800 p-4 border-2 border-gray-950 flex items-center gap-4">
                        <div className="w-10 h-10 bg-white dark:bg-gray-950 border-2 border-gray-950 flex items-center justify-center text-primary-600 rounded-xl">
                            <Clock size={20} />
                        </div>
                        <div>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <input 
                                    ...
                                    className="w-full text-xs font-medium p-3 bg-white dark:bg-gray-950 border-2 border-gray-950 focus:ring-4 focus:ring-amber-500/20 outline-none rounded-xl"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                className="w-full text-xs font-medium p-3 bg-white dark:bg-gray-950 border-2 border-gray-950 focus:ring-4 focus:ring-amber-500/20 outline-none min-h-[100px] resize-none rounded-xl"
                            />
                        </div>

                        <div className="flex items-start gap-2 p-3 bg-blue-50 dark:bg-blue-900/10 border-2 border-gray-950 rounded-xl">
                ...
                <div className="p-6 bg-gray-50 dark:bg-gray-800 border-t-4 border-gray-950 flex gap-4">
                    <button 
                        onClick={onClose}
                        className="flex-1 py-4 bg-white text-gray-950 border-2 border-gray-950 font-medium text-xs uppercase tracking-widest hover:bg-gray-100 transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,0.5)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none rounded-xl"
                    >
                        إلغاء
                    </button>
                    <button 
