          ...
          <div className="flex gap-1 rounded-2xl border border-border bg-card p-1">
            {tabs.map((tab) => (
              <motion.button
                ...
                className={cn(
                  'relative flex flex-1 items-center justify-center gap-1.5 rounded-xl px-2 py-2.5 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus',
                  ...
                  <>
                    ...
                    {!isTeacher && (
                      <div className="flex gap-2">
                        <div className="flex min-w-0 flex-1 items-center gap-1.5 rounded-xl border border-border bg-card px-2 py-1.5">
                          <GraduationCap size={13} className="shrink-0 text-primary" />
                          <select
                            value={filterTeacher}
                            onChange={(e) => setFilterTeacher(e.target.value)}
                            aria-label="تصفية حسب المعلمة"
                            className="min-w-0 flex-1 cursor-pointer appearance-none truncate rounded-lg bg-transparent px-1 py-0.5 text-micro font-bold text-main outline-none focus-visible:ring-2 focus-visible:ring-focus"
                          >
