  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center gap-2">
        <span className="flex items-center gap-1.5 rounded-xl bg-success-soft px-2.5 py-1.5">
        ...
        {!isTeacher && (
          <label className="flex items-center gap-2 rounded-xl border border-border bg-surface px-3 py-1.5">
        ...
        <span className="hidden items-center gap-1.5 rounded-xl bg-surface px-2.5 py-1.5 md:flex">
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="flex items-center gap-1.5 rounded-xl bg-primary-soft px-2.5 py-1.5">
