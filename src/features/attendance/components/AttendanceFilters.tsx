        ...
        <div className="mb-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {periodFilter && onPeriodChange && (
              <div className="flex gap-0.5 rounded-lg bg-surface p-0.5" dir="ltr">
                {(Object.keys(periodLabels) as PeriodFilter[]).map((key) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative whitespace-nowrap rounded-md px-2.5 py-1 text-[9px] font-bold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus ${isActive ? 'text-on-primary' : 'text-muted hover:text-main'}`}
                    >
                      {isActive && (
                        <motion.div
            ...
            {hasActiveFilters && (
              <button
                ...
                className="flex items-center gap-1 rounded-lg bg-error-soft px-2 py-1 text-[9px] font-bold text-error transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus"
              >
                <X size={10} /> مسح
              </button>
            )}
        ...
        {periodFilter === 'custom' && (
          ...
          >
            ...
            <input
              ...
              className="rounded-lg border border-border bg-surface px-2 py-1.5 text-[9px] font-bold outline-none transition-all focus-visible:border-primary"
            />
        ...
        <div className="flex flex-col gap-2 md:flex-row">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full rounded-lg border border-border bg-surface py-2 pe-3 ps-8 text-[10px] font-medium transition-all focus-visible:border-primary focus-visible:outline-none"
            />
          </div>
          ...
          <div className="flex flex-wrap gap-2">
            <div className="relative">
              ...
              <select
                ...
                className="cursor-pointer appearance-none rounded-lg border border-border bg-surface py-2 pe-3 ps-8 text-[10px] font-medium transition-all focus-visible:border-primary focus-visible:outline-none"
              >
