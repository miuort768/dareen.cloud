        ...
        <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
            <div className="bg-white dark:bg-slate-900 w-full max-w-2xl rounded-2xl shadow-sm border border-slate-100/50 dark:border-slate-800/50 animate-in zoom-in-95 max-h-[90vh] flex flex-col overflow-hidden">
                                    ...
                                    {editingSession?.id === session.id ? (
                                        <div className="flex-1 flex items-center gap-4 p-4">
                                            <input
                                                ...
                                                className="px-3 py-2 text-[10px] font-bold border border-slate-200 dark:border-slate-700 rounded-xl bg-white dark:bg-slate-900 outline-none focus:border-[#2563EB] transition-all"
                                            />
                                            <select
                                            ...
                                            <div className="flex items-center gap-3 ps-0 p-4">
                                                ...
                                                <div className="flex gap-1 opacity-100 lg:opacity-0 group-hover:opacity-100 transition-opacity">
                                                    <button
                                                        ...
                                                        className="p-2 rounded-xl transition-all shadow-sm active:scale-95" style={{ backgroundColor: '#2563EB12', color: '#2563EB' }}
                                                        title="تعديل"
                                                    >
                                                        <Edit2 size={14} />
                                                    </button>
                ...
                <div className="p-5 border-t border-slate-100/50 dark:border-slate-800/50">
                    <button
                        onClick={onClose}
                        className="w-full bg-[#172554] text-white font-bold py-3 text-sm rounded-xl shadow-sm hover:bg-blue-900 transition-all active:scale-95"
                    >
                        إغلاق
                    </button>
                </div>
