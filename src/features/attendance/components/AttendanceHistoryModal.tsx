            ...
            <div className="bg-white dark:bg-slate-900 w-full max-w-2xl rounded-none shadow-sm border border-slate-100/50 dark:border-slate-800/50 animate-in zoom-in-95 max-h-[90vh] flex flex-col overflow-hidden">
                    ...
                    <div>
                        ...
                        <div className="mt-2">
                            ...
                            <div className="flex flex-wrap gap-2 mt-1">
                                {studentGrade && (
                                    <span className="text-[10px] font-bold px-2 py-0.5 rounded-none" style={{ backgroundColor: '#ffffff15', color: '#ffffff' }}>
                                        الصف {studentGrade}
                                    </span>
                                )}
                                {studentCurriculum && (
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar">
                    {loading ? (
                        ...
                        <div className="space-y-3 p-5">
                            {history.map((session) => (
                                <div
                                    key={session.id}
                                    className={cn(
                                        "flex items-center justify-between transition-all group bg-white dark:bg-slate-900 border rounded-none shadow-sm",
                                    ...
                                    {editingSession?.id === session.id ? (
                                        <div className="flex-1 flex items-center gap-4 p-4">
                                            ...
                                            <div className="flex gap-2 mr-auto">
                                                <button
                                                    ...
                                                    className="p-2 rounded-none transition-all shadow-sm active:scale-95" style={{ backgroundColor: '#10B98112', color: '#10B981' }}
                                                    title="حفظ"
                                                >
                                                    <Save size={16} />
                                                </button>
                                                <button
                                                    ...
                                                    className="p-2 rounded-none transition-all" style={{ backgroundColor: '#64748B12', color: '#64748B' }}
                                                    title="إلغاء"
                                                >
                                                    <XSquare size={16} />
                                                </button>
                                        ...
                                        <>
                                            <div className="flex items-center gap-4 p-4">
                                                <div className="w-10 h-10 rounded-none flex items-center justify-center" style={{ backgroundColor: session.status === 'completed' ? '#10B98112' : '#F43F5E12' }}>
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="text-[10px] font-bold px-2 py-0.5 rounded-none" style={{ backgroundColor: '#64748B12', color: '#64748B' }}>{session.day}</span>
                                                    </div>
                                                        ...
                                                        <div className="mt-3 space-y-2 pb-1">
                                                            {session.topics && (
                                                                <div className="flex gap-2">
                                                                    <span className="text-[9px] font-bold px-1.5 py-0.5 h-fit whitespace-nowrap rounded-none" style={{ backgroundColor: '#10B98112', color: '#10B981' }}>المنجز</span>
                                                            ...
                                                            {session.homework && (
                                                                <div className="flex gap-2">
                                                                    <span className="text-[9px] font-bold px-1.5 py-0.5 h-fit whitespace-nowrap rounded-none" style={{ backgroundColor: '#F59E0B12', color: '#D97706' }}>الواجب</span>
                                            ...
                                            <div className="flex items-center gap-3 ps-0 p-4">
                                                <span className="text-[10px] font-bold px-2 py-1 rounded-none" style={{ backgroundColor: session.status === 'completed' ? '#10B98112' : '#F43F5E12', color: session.status === 'completed' ? '#10B981' : '#F43F5E' }}>
                                                ...
                                                <div className="flex gap-1 opacity-100 lg:opacity-0 group-hover:opacity-100 transition-opacity">
                                                    ...
                                                    <button
                                                        ...
                                                        className="p-2 rounded-none transition-all shadow-sm active:scale-95" style={{ backgroundColor: '#F43F5E12', color: '#F43F5E' }}
                                                        title="حذف"
                        ...
                        <div className="py-12 text-center flex flex-col items-center gap-4 mx-5 mb-5 bg-white dark:bg-slate-900 border border-dashed border-slate-200 dark:border-slate-700 rounded-none">
                            <div className="w-12 h-12 rounded-none flex items-center justify-center" style={{ backgroundColor: '#64748B12' }}>
