    ...
    >
      ...
      {show && (
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          className="absolute -top-1 left-1/2 z-20 -translate-x-1/2 -translate-y-full whitespace-nowrap rounded-2xl bg-main px-2 py-1 text-[9px] font-bold text-inverse shadow-lg"
        >
          {text}
