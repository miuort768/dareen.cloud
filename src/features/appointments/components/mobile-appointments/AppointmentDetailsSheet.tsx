    ...
    footer={
      activeTab === 'upcoming' && canComplete && appointment ? (
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-none bg-success py-3 text-micro font-bold text-on-success transition-transform active:scale-[0.98]"
        >
    ...
    {appointment && (
      <div className="space-y-3">
        <div className="flex justify-center pb-1">
          <div className="rounded-none bg-primary-soft px-4 py-2">
