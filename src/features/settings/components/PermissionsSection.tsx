                  ...
                  {perms.map((p) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'flex items-center gap-2 rounded-xl border px-3 py-2.5 text-start text-[11px] font-bold outline-none transition-all focus-visible:ring-2 focus-visible:ring-focus',
                          isSelected
