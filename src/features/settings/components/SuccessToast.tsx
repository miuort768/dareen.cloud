...
export const SuccessToast = ({ showSuccess, message }: SuccessToastProps) => {
    ...
    return (
        <div className="fixed bottom-6 left-6 z-[2000] flex items-center gap-3 bg-card border border-border px-4 py-3 shadow-sm animate-in slide-in-from-bottom-4 duration-300">
