...
export const AcademyInfoSection = ({
    ...
    return (
        <SectionCard>
            <SectionTitle icon={Hash} label="معلومات المعهد" sub="البيانات الأساسية للمعهد وروابط التواصل" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <Hash size={14} className="absolute start-3 top-1/2 -translate-y-1/2 text-muted" />
                            <InputField value={localLibraryTelegram} onChange={e => setLocalLibraryTelegram(e.target.value)} className="ps-9" placeholder="https://t.me/..." />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <FooterSettingsSection
                localFooterDescription={localFooterDescription} setLocalFooterDescription={setLocalFooterDescription}
                localFooterAddress={localFooterAddress} setLocalFooterAddress={setLocalFooterAddress}
                localFooterInstagram={localFooterInstagram} setLocalFooterInstagram={setLocalFooterInstagram}
            />
