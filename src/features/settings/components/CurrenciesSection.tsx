                        ...
                        <table className="w-full text-xs">
                            <thead>
                                <tr className="border-b border-border">
                                    <th className="text-end py-2 px-3 text-muted font-bold">الرمز</th>
                                    <th className="text-end py-2 px-3 text-muted font-bold">الاسم</th>
                                    <th className="text-end py-2 px-3 text-muted font-bold">الرمز</th>
                                    <th className="text-end py-2 px-3 text-muted font-bold">الحالة</th>
                                    <th className="text-start py-2 px-3 text-muted font-bold"></th>
                                </tr>
                            </thead>
                            <tbody>
                                {currencies.map(c => (
                ...
                <>
                    ...
                    <div className="overflow-x-auto max-h-80 overflow-y-auto">
                        <table className="w-full text-xs">
                            <thead>
                                <tr className="border-b border-border">
                                    <th className="text-end py-2 px-3 text-muted font-bold">من</th>
                                    <th className="text-end py-2 px-3 text-muted font-bold">إلى</th>
                                    <th className="text-end py-2 px-3 text-muted font-bold">الشراء</th>
                                    <th className="text-end py-2 px-3 text-muted font-bold">البيع</th>
                                    <th className="text-end py-2 px-3 text-muted font-bold">التاريخ</th>
                                    <th className="text-start py-2 px-3 text-muted font-bold"></th>
                                </tr>
                            </thead>
                            <tbody>
