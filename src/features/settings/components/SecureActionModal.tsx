...
export const SecureActionModal = ({ secureAction, secureInput, setSecureInput, setSecureAction }: SecureActionModalProps) => {
    ...
    return (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4  bg-black/50 animate-in fade-in">
            <div className="bg-white dark:bg-slate-900 rounded-none p-6 max-w-md w-full shadow-sm border border-rose-100 dark:border-rose-900">
                <div className="flex flex-col items-center text-center space-y-3">
                    <div className="w-12 h-12 bg-rose-50 dark:bg-rose-900/30 rounded-none flex items-center justify-center text-rose-500 mb-1">
                        <AlertCircle size={24} />
                    </div>
                    ...
                    <div className="w-full bg-slate-50 dark:bg-slate-800 p-4 rounded-none border border-slate-100 dark:border-slate-700 space-y-3 text-right mt-2">
                    ...
                    <div className="flex gap-2 w-full pt-2">
                        ...
                        <button
                            ...
                            className="flex-1 py-2 bg-rose-500 hover:bg-rose-600 text-white text-xs font-normal rounded-none disabled:opacity-40 disabled:cursor-not-allowed transition-all"
                        >
                            تنفيذ نهائي
                        </button>
                    </div>
