...
export const DeleteUserModal = ({ showDeleteModal, setShowDeleteModal, deleteUser, showNotify }: DeleteUserModalProps) => {
    ...
    return (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4  bg-black/40 animate-in fade-in">
            <div className="bg-white dark:bg-slate-900 p-6 max-w-sm w-full shadow-sm border border-slate-100 dark:border-slate-800">
                <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 bg-rose-50 dark:bg-rose-900/20 flex items-center justify-center">
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className="flex-1 py-2 bg-rose-500 hover:bg-rose-600 text-white text-xs font-normal transition-all"
                    >
                        تأكيد الحذف
                    </button>
                </div>
