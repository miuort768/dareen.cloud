                            ...
                            <div className="grid grid-cols-[80px_repeat(7,1fr)] border-b border-border">
                                ...
                                {DAYS_OF_WEEK.map((day) => (
                                    <div key={day} className={cn(
                                        "p-3 text-micro font-bold text-center border-s border-border last:border-s-0 bg-primary-active dark:bg-background",
                                    ...
                                    <div key={`${slot.hour}-${slot.period}`} className={cn(
                                        ...
                                        {DAYS_OF_WEEK.map((day) => {
                                            ...
                                            return (
                                                <div
                                                    key={`${day}-${slot.hour}`}
                                                    className="p-2 border-s last:border-s-0 border-b border-border/50 dark:border-border/50 min-h-[72px]"
                                                >
                                                    {!isEmpty && (
