...
export const Evaluations = () => {
    ...
    if (isLoading) return (
        <div className="space-y-4 p-6">
            {[...Array(6)].map((_, i) => <div key={i} className="h-40 bg-slate-100 animate-pulse" />)}
        </div>
    );

    return (
        <div className="min-h-full pb-24 overflow-x-hidden relative bg-gradient-to-br from-slate-50 via-white to-rose-50/30 dark:from-[#020617] dark:via-slate-950 dark:to-rose-950/20 font-dash" dir="rtl">
