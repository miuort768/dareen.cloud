        ...
        <div className="space-y-4">
            <div className="bg-primary shadow-lg px-5 md:px-7 py-5 flex flex-col md:flex-row md:items-center justify-between gap-4 rounded-card mt-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    {showAddButton && (
                        <button onClick={onAddClick} className="flex items-center gap-1.5 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-on-primary font-bold text-micro px-3 py-2 shadow-soft active:scale-95 transition-all shrink-0 rounded-xl">
            ...
            <div className="bg-white/80 backdrop-blur-xl shadow-soft border border-white/20 p-3 rounded-card">
