...
export const EvaluationsHeader = ({ totalXP, showAddButton, searchTerm, onSearchChange, onAddClick }: EvaluationsHeaderProps) => {
    return (
        <div className="space-y-4">
            <div className="shadow-sm px-5 md:px-7 py-5 flex flex-col md:flex-row md:items-center justify-between gap-4 rounded-none" style={{ backgroundColor: '#E11D48' }}>
                ...
                <div className="flex items-center gap-2">
                    ...
                    {showAddButton && (
                        <button onClick={onAddClick} className="flex items-center gap-1.5 bg-white hover:bg-white/90 text-[#E11D48] font-bold text-[10px] px-3 py-2 shadow-sm active:scale-95 transition-all shrink-0 rounded-none">
            ...
            <div className="shadow-sm p-3 rounded-none" style={{ backgroundColor: '#E11D48' }}>
