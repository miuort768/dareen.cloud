            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-rose-900 via-rose-800 to-slate-900 dark:from-slate-950 dark:via-rose-950 dark:to-slate-950 rounded-2xl shadow-sm shadow-rose-500/15 border border-white/5 px-6 md:px-8 py-6 flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                ...
                <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                        <div className="w-10 h-10 md:w-14 md:h-14 bg-white/15 flex items-center justify-center rounded-xl border border-white/20 shadow-inner shrink-0">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="bg-white/15 border border-white/20 px-3 md:px-4 py-2 rounded-lg flex items-center gap-1.5 md:gap-2">
                        ...
                        {showAddButton && (
                            <button onClick={onAddClick} className="flex items-center gap-1.5 bg-white text-blue-700 dark:bg-rose-500 dark:text-white font-medium text-[10px] md:text-xs px-3 md:px-4 py-2 shadow-sm hover:shadow-sm hover:scale-105 transition-all shrink-0 self-stretch rounded-lg">
