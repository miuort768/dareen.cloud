        ...
        <div className={cn(
            ...
            <div className="p-6 space-y-6 overflow-y-auto max-h-[calc(100vh-200px)] lg:max-h-none">
                ...
                <div className="p-5 bg-gradient-to-br from-primary-soft to-surface dark:from-primary-soft dark:to-surface border border-border rounded-2xl shadow-sm relative overflow-hidden">
                    <div className="absolute top-0 start-0 w-16 h-16 bg-success/5 -rotate-45 translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
                ...
                <div className="space-y-4">
                    <div className="flex items-stretch h-9 w-fit group cursor-default">
                        <div className="bg-card px-4 flex items-center justify-center border-y border-s border-border min-w-[44px] rounded-s-xl transition-colors">
                            <span className="text-xs font-medium text-primary">{enrolledStudents.length}</span>
                        </div>
                        <div className="bg-gradient-to-l from-primary to-primary-light text-on-primary px-4 flex items-center justify-center rounded-e-xl relative overflow-hidden transition-all">
