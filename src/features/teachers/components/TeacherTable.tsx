    ...
    if (teachers.length === 0) {
        return (
            <div className="py-24 text-center opacity-40">
                ...
                <p className="text-[10px] font-normal text-dim uppercase tracking-[4px]">لا توجد بيانات معلمات حالياً</p>
            </div>
        );
    }
                    ...
                    <table className="w-full text-right border-collapse">
                        <thead>
                            <tr className="bg-primary">
                                <th className="px-6 py-4 font-bold text-[10px] uppercase tracking-[0.2em] text-on-primary opacity-80">المعلمة</th>
                                <th className="px-6 py-4 font-bold text-[10px] uppercase tracking-[0.2em] text-on-primary opacity-80 text-center">التخصص</th>
                                <th className="px-6 py-4 font-bold text-[10px] uppercase tracking-[0.2em] text-on-primary opacity-80 text-center">الطلاب</th>
                                <th className="px-6 py-4 font-bold text-[10px] uppercase tracking-[0.2em] text-on-primary opacity-80 text-center">التعريفة</th>
                                <th className="px-6 py-4 font-bold text-[10px] uppercase tracking-[0.2em] text-on-primary opacity-80 text-center">إجراءات</th>
                            </tr>
                        </thead>
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[9px] font-bold text-dim mt-0.5">ID: {teacher.id.substring(0, 8)}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 text-center">
                                            <span className="text-[10px] font-bold px-2 py-0.5 rounded-xl bg-primary-soft text-primary">
                                                {teacher.subject}
                                            </span>
                                        </td>
                                        <td className="px-6 py-4 text-center">
                                            <span className="w-7 h-7 inline-flex items-center justify-center font-bold text-[11px] rounded-xl bg-info-soft text-info">
                    ...
                    return (
                        ...
                        >
                            <div className="flex justify-between items-start mb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-[9px] font-bold px-1.5 py-0.5 uppercase rounded-xl bg-primary-soft text-primary">{teacher.subject}</span>
                                    </div>
                                </div>
                                <div className="text-left">
                                    <span className="text-xs font-bold text-success block leading-none">{teacher.price}</span>
                                    <span className="text-[8px] font-bold text-success opacity-60 uppercase">ج.م / حصة</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-2 pt-1">
                                <button onClick={(e) => { e.stopPropagation(); onChat(teacher.id); }} className="flex-1 h-9 rounded-xl bg-primary text-on-primary font-bold text-[10px] shadow-sm active:scale-95 transition-all hover:shadow-lg hover:shadow-primary/25">مراسلة</button>
