...
export const TeacherTable = ({ teachers, onEdit, onDelete, onSelect, onChat, selectedId, studentCounts }: TeacherTableProps) => {
    if (teachers.length === 0) {
        return (
            <div className="bg-white dark:bg-gray-900 rounded-none border border-gray-100 dark:border-gray-800 p-12 text-center">
                <div className="w-16 h-16 bg-gray-50 dark:bg-gray-800 rounded-none flex items-center justify-center mx-auto mb-4">
    ...
    return (
        <div className="space-y-4">
            {/* Desktop Table */}
            <div className="hidden lg:block bg-white dark:bg-gray-900 rounded-none border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
                        ...
                        {teachers.map(teacher => {
                            ...
                            return (
                                <tr
                                    ...
                                    className={cn(
                                        "group cursor-pointer hover:bg-primary-50/30 dark:hover:bg-primary-900/5",
                                        isSelected && "bg-primary-50 dark:bg-primary-900/10"
                                    )}
                                >
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-3">
                                            <div className="w-10 h-10 rounded-none bg-gradient-to-br from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-900/40 flex items-center justify-center text-primary-600 font-black border border-primary-200/20 shadow-sm">
                                    ...
                                    <td className="px-6 py-4">
                                        <span className="px-3 py-1 bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-400 rounded-none text-xs font-bold border border-gray-100 dark:border-gray-700">
                                            {teacher.subject}
                                        </span>
                                    </td>
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center justify-center gap-2">
                                            <button
                                                ...
                                                className="w-9 h-9 flex items-center justify-center text-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-none"
                                                title="تعديل"
                                            >
                                                <Edit size={18} />
                                            </button>
                                            <button
                                                ...
                                                className="w-9 h-9 flex items-center justify-center text-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 rounded-none"
                                                title="مراسلة"
                                            >
                                            ...
                                            <button
                                                ...
                                                className="w-9 h-9 flex items-center justify-center text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-900/20 rounded-none"
                                                title="حذف"
                                            >
                                                <Trash2 size={18} />
                                            </button>
                    ...
                    return (
                        ...
                        >
                            <div className="flex items-start justify-between mb-4">
                                <div className="flex items-center gap-3">
                                    <div className="w-12 h-12 rounded-none bg-primary-600 text-white flex items-center justify-center font-black text-xl shadow-lg shadow-primary-600/20">
                                        {teacher.name.charAt(0)}
                                    </div>
                                    <div>
                                ...
                                <div className="text-left bg-emerald-50 dark:bg-emerald-900/20 px-3 py-1.5 rounded-none border border-emerald-100 dark:border-emerald-800/50">
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-5">
                                <div className="bg-gray-50 dark:bg-gray-800/50 rounded-none p-3 flex flex-col items-center">
                                ...
                                <div className="bg-gray-50 dark:bg-gray-800/50 rounded-none p-3 flex flex-col items-center">
                                    <div className="w-4 h-4 rounded-none bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.3)] mb-1" />
                            ...
                            <div className="flex items-center gap-2 pt-2 border-t border-gray-50 dark:border-gray-800">
                                <button
                                    onClick={(e) => { e.stopPropagation(); onChat(teacher.id); }}
                                    className="flex-1 bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400 py-3 rounded-none flex items-center justify-center gap-2 font-black text-xs"
                                >
                                ...
                                <button
                                    onClick={(e) => { e.stopPropagation(); onEdit(teacher); }}
                                    className="w-12 h-12 flex items-center justify-center border border-gray-100 dark:border-gray-800 text-gray-400 hover:text-blue-500 hover:bg-blue-50 rounded-none"
                                >
                                    <Edit size={18} />
                                </button>
                                <button
                                    onClick={(e) => { e.stopPropagation(); onDelete(teacher.id); }}
                                    className="w-12 h-12 flex items-center justify-center border border-rose-50 dark:border-rose-900/10 text-rose-300 hover:text-rose-500 hover:bg-rose-50 rounded-none"
                                >
                                    <Trash2 size={18} />
                                </button>
                            </div>
