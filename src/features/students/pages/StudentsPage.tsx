                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-100/50 dark:border-slate-800/50 shadow-sm rounded-none">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-3 p-3">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button onClick={() => { /* export */ }} className="flex items-center gap-1.5 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 text-[10px] font-bold px-2.5 py-1.5 border border-slate-100 dark:border-slate-700 transition-all shadow-sm active:scale-[0.97] rounded-none"><Download size={12} /> تصدير</button>
