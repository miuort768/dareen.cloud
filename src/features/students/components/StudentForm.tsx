      ...
      <div className="flex items-center justify-between gap-4 bg-primary px-4 py-6 md:gap-6 md:px-6 md:py-8">
        ...
        {onCancel && (
          <button
            type="button"
            onClick={onCancel}
            className="flex h-10 w-10 items-center justify-center text-white/90 outline-none transition-all hover:bg-white/15 focus-visible:ring-2 focus-visible:ring-focus"
          >
            <X size={20} />
          </button>
        )}
