            ...
            <div className="bg-primary p-3 shadow-sm flex flex-col md:flex-row items-center justify-between gap-4 rounded-none" dir="rtl">
                ...
                <div className="relative flex-1 w-full">
                    ...
                    <input
                        ...
                        className="w-full pe-6 ps-9 py-2 text-xs font-bold text-on-primary placeholder:text-on-primary placeholder:opacity-50 outline-none transition-all rounded-none bg-white/15 border border-white/20"
                    />
                </div>
                ...
                <div className="flex items-center gap-2 w-full md:w-auto justify-end">
                    ...
                    <div className="flex items-center gap-1.5 border-s border-white/20 ps-2 ms-1">
