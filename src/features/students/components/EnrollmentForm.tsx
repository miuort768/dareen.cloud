...
export const EnrollmentForm = ({ teachers, onSubmit }: EnrollmentFormProps) => {
    ...
    return (
        <div className="pt-8 border-t border-gray-100 dark:border-gray-800">
            <h4 className="text-[10px] font-medium text-gray-900 uppercase tracking-widest mb-4 dark:text-white">إضافة اشتراك جديد</h4>
            <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div className="bg-primary-50/50 p-3 space-y-3 dark:bg-primary-900/10">
                    <p className="text-[9px] font-medium text-primary-700 uppercase dark:text-primary-400">المواعيد</p>
                    ...
                    <div className="flex flex-wrap gap-1">
                        {schedule.map((s, idx) => (
                            <div key={idx} className="bg-white px-2 py-1 text-[9px] font-medium border border-primary-200 flex items-center gap-1 dark:bg-gray-800 dark:border-primary-900 shadow-sm">
                                {s.day} {s.hour}
