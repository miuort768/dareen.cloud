...
export const StudentCard = ({ student, onClose }: StudentCardProps) => {
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/60  animate-in fade-in duration-300">
            <div className="bg-card w-full max-w-md border-4 border-border shadow-[20px_20px_0px_0px_#0000004D] relative overflow-hidden group">
                ...
                <div className="p-8 relative print:p-0">
                    {/* Background Pattern */}
                    <div className="absolute top-0 right-0 w-48 h-48 bg-surface border-r-8 border-t-8 border-border -mr-16 -mt-16 rotate-45 pointer-events-none"></div>
