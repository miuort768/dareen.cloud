        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="bg-white dark:bg-gray-950 w-full max-w-md border-4 border-gray-900 shadow-[20px_20px_0px_0px_rgba(0,0,0,0.3)] relative overflow-hidden group">
                ...
                <div className="p-4 flex justify-between items-center border-b-2 border-gray-100 dark:border-gray-800 print:hidden">
                    <h3 className="font-black text-xs uppercase tracking-[0.3em] text-gray-400 italic">Student ID Card</h3>
                ...
                <div className="p-8 relative print:p-0">
                    ...
                    <div className="flex justify-between items-start mb-10 relative z-10">
                        <div className="space-y-1">
                            ...
                            <h2 className="text-xl font-black text-gray-900 dark:text-white leading-none">بطاقة تعريف طالب</h2>
                        </div>
                        <div className="w-16 h-16 bg-gray-950 border-4 border-white/20 flex items-center justify-center shadow-lg">
                    ...
                    <div className="flex flex-col md:flex-row gap-8 relative z-10">
                        ...
                        <div className="flex-1 space-y-4 text-right" dir="rtl">
                            <div className="space-y-1">
                                ...
                                <p className="text-lg font-black text-gray-900 dark:text-white tracking-tighter">{student.name}</p>
                            </div>
                            
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1">
                                    <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest block">الصف الدراسي</label>
                                    <p className="text-sm font-bold text-gray-700 dark:text-gray-300">{student.grade}</p>
                                </div>
                                <div className="space-y-1">
                                    <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest block">كود الطالب</label>
                                    <p className="text-sm font-bold text-gray-700 dark:text-gray-300">#{student.id.slice(0, 6).toUpperCase()}</p>
                                </div>
                            </div>

                            <div className="space-y-1 pt-2 border-t border-gray-100 dark:border-gray-800">
                                <div className="flex items-center justify-end gap-2 text-emerald-600">
                                    <span className="text-xs font-bold tabular-nums">{student.parentPhone}</span>
                                    <Phone size={14} />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="absolute left-0 bottom-10 h-32 w-8 -rotate-90 flex items-center gap-2 pointer-events-none opacity-20">
                         <span className="text-[8px] font-black text-gray-500 uppercase whitespace-nowrap tracking-[1em]">STU-ID-{student.id.slice(0,4)}</span>
                    </div>
                </div>
