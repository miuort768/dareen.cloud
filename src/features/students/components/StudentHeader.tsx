...
export const StudentHeader = ({ count, showAddForm, onToggleAddForm }: StudentHeaderProps) => {
    return (
        <div className="relative overflow-hidden bg-rose-600 px-4 md:px-8 py-8 flex flex-row items-center justify-between gap-4 border-b border-rose-700 rounded-none shadow-sm" dir="rtl">
            ...
            <div className="relative z-10 flex items-center gap-3 no-print">
                <button
                    ...
                    className={cn(
                        "h-12 px-6 flex items-center justify-center gap-2 text-[11px] font-medium uppercase tracking-widest rounded-none transition-all shadow-sm active:scale-95 border",
                        showAddForm 
