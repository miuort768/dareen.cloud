...
export const GamificationCard = ({ totalPoints, badges, pointLogs = [] }: GamificationCardProps) => {
    ...
    return (
        <div className="space-y-3 md:space-y-4">
            ...
            <div className="bg-indigo-600 dark:bg-indigo-600 p-3 md:p-4 rounded-none md:rounded-none shadow-sm shadow-indigo-600/20 relative overflow-hidden group">
                ...
                <div className="flex items-center justify-between relative z-10">
                    ...
                    <div className="w-8 h-8 md:w-10 md:h-10 bg-white/10 rounded-lg md:rounded-none flex items-center justify-center  border border-white/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                {/* Badges Collection */}
                <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-3 md:p-4 rounded-none md:rounded-none shadow-sm">
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-3 md:p-4 rounded-none md:rounded-none shadow-sm flex flex-col">
                    <h3 className="font-medium text-[8px] md:text-[9px] uppercase tracking-widest text-slate-400 mb-3 flex items-center gap-1.5">
